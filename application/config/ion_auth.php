 ...
 */
$config['site_title']                 = "scouts.gov.bd";       	// Site Title, example.com
$config['admin_email']                = "admin@scouts.gov.bd"; 	// Admin Email, admin@example.com
...
$config['user_expire']                = 7200; //86400        // How long to remember the user (seconds). Set to zero for no expiration
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'login/email/';
...
$config['message_start_delimiter'] = '<div class="alert alert-success alert-dismissible"> <i class="icon fa fa-check"></i> '; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger alert-dismissible"> <i class="fa fa-warning"></i> ';		// Error message start delimiter
