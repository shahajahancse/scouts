...
<head>
  ...
  <style type="text/css">    
    ...
    .id_box_back{border: 1px solid #b44dff; width: 350px; height: 190px;}
    ...
    .id_logo_blood{float: right; width: 30px; height:25px; padding: 15px 0px 0px 5px; margin: 0px 10px; auto;font-weight: bold;color: white;border: 0px solid yellow;background-image: url(<?= base_url('awedget/assets/img/blood_drop.png');?>); background-repeat: no-repeat;background-size: 23mm 28mm;}
...
<body>  
  ...
  <div class="id_box_back">
    <div class="id_back_left_content">
      ...
      <div class="id_label_value"><?=$member_type?></div>
    ...
    <div style="width: 130px; border: 0px solid black; float: left; margin-top: 5px; margin-left: 10px; margin-bottom: 5px;">
      <span style="padding-left: 22%; padding-top: ; font-size: 10px;">Expire Date : <br>
        <?= date_detail_format(date('Y-m-d', strtotime("+5 years", $info->created_on)));?>
      </span>
    </div>
    <div style="width: 160px; border: 0px solid black; float: right; text-align: right; margin-top: 0px; margin-right: 10px;">
      <span style="padding-left: 20%; padding-top: 10px; font-size: 10px;">If found, <br>please return to BDSCOUT.</span>
    </div>
    <div class="id_clear"></div>
    <div style="height: 15px; background-color: #1aa326; font-size: 12px; text-align: center; padding-top: 2px;color: white; font-weight: bold;">scouts.gov.bd</div>
  </div>
