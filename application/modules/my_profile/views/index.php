...
<?php if ( $info->sc_rover == 'Yes' ) {?>
                ...
                <div class="tab-pane" id="activities">
                  <div class="row">
                    <div class="col-md-12">
                      <h3><span class="semi-bold">Activities</span></h3>

                      <div class="table-responsive">
                        <table class="profile_table table" width="100%">
                          ...
                          <?php for ( $i = 0; $i < sizeof( $camping ); $i++ ) {?>
                            <tr>
                              <td data-label="ক্রম"><?=$i + 1?></td>
                              <td data-label="সেকসন"><?=get_scout_section( $camping[$i]->section_id );?></td>
                              <td data-label="ক্যাম্পের নাম"><?=$camping[$i]->camp_name;?></td>
                              <td data-label="স্থান"><?=$camping[$i]->area;?></td>
                              <td data-label="সনদ নং"><?=$camping[$i]->certificate_no;?></td>
                              <td data-label="ক্যাম্প তারিখ"><?=date_bangla_format( $camping[$i]->camp_date );?></td>
                              <td data-label="মূল্যায়নকারী"><?=$camping[$i]->examiner_id;?></td>
                              <td data-label="যাচাইকারী"><?=$camping[$i]->scout_id;?></td>
                            </tr>
                          <?php }?>
                        </table>
                      </div>
                      ...
                      <div class="table-responsive mt-4">
                        <table class="profile_table table" width="100%">
                          ...
                          <?php for ( $i = 0; $i < sizeof( $badge_training ); $i++ ) {?>
                            <tr>
                              <td data-label="ক্রম"><?=$i + 1?></td>
                              <td data-label="সেকসন"><?=get_scout_section( $badge_training[$i]->section_id );?></td>
                              <td data-label="ব্যাজ"><?=$badge_training[$i]->badge_type_name_bn;?></td>
                              <td data-label="প্রশিক্ষণের নাম"><?=$badge_training[$i]->training_name;?></td>
                              <td data-label="সনদ নং"><?=$badge_training[$i]->certificate_no;?></td>
                              <td data-label="প্রশিক্ষণের তারিখ"><?=date_bangla_format( $badge_training[$i]->training_date );?></td>
                              <td data-label="মূল্যায়নকারী"><?=$badge_training[$i]->examiner_id;?></td>
                              <td data-label="যাচাইকারী"><?=$badge_training[$i]->scout_id;?></td>
                            </tr>
                          <?php }?>
                        </table>
                      </div>
                      ...
                      <div class="table-responsive mt-4">
                        <table class="profile_table table" width="100%">
                          ...
                          <?php for ( $i = 0; $i < sizeof( $promotion ); $i++ ) {?>
                            <tr>
                              <td data-label="ক্রম"><?=$i + 1?></td>
                              <td data-label="সেকসন"><?=get_scout_section( $promotion[$i]->section_id );?></td>
                              <td data-label="রোল"><?=$promotion[$i]->role_type_name_bn;?></td>
                              <td data-label="পদোন্নতির শুরুর তারিখ"><?=date_bangla_format( $promotion[$i]->from_date );?></td>
                              <td data-label="পদোন্নতির শেষ তারিখ"><?=date_bangla_format( $promotion[$i]->to_date );?></td>
                              <td data-label="ব্যাজ"><?=$promotion[$i]->badge_type_name_bn;?></td>
                              <td data-label="মূল্যায়নকারী"><?=$promotion[$i]->examiner_id;?></td>
                              <td data-label="যাচাইকারী"><?=$promotion[$i]->scout_id;?></td>
                            </tr>
                          <?php }?>
                        </table>
                      </div>
