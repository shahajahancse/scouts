    ...
    <div class="grid simple horizontal red">
     <div class="grid-title">
      ...
      <div class="pull-right">  
        ...
        <?php /*
        <a href="<?=base_url('my_profile/pdf_id_card_test')?>" target="_blank" class="btn btn-success btn-xs btn-mini"> Download Scout ID Card Test</a>
        */ ?>
      </div>
    </div>
    ...
    <div class="grid-body">
       ...
       <div class="col-md-12">
        ...
        <div class="id_box_back">
          ...
          <div class="id_back_right_content">
            ...
            <img src="<?=base_url('qrcode_img/'.$info->qr_img)?>" class="img-thu rounded" style="height: 75px; width: 75px" >
            <?php } ?>
          </div>          
          <div class="id_clear"></div>
          <div class="id_group">
          ...
          <div class="id_expaire">
            <span class="id_expaire_text">Expire Date : </span>
              <span class="id_expaire_text">
      ...
      <?php }else{ ?>
        ...
        <div class="alert alert-warning">
           <h4 class="semi-bold">ID card is not being generated because your picture/image are not yet attached.</h4>
        </div>
