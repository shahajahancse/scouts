            ...
            <table class="table table-hover table-condensed" id="example">
              <thead>
                <tr>
                  ...
                  <th style="width:10%">Apply As <br>App. Date</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="v-align-middle"><a href="<?=base_url('events/details/'.$row->eventid);?>" target="_blank" ><strong><?=$row->event_title?></strong></a> <br> <?=date('d M, Y', strtotime($row->event_start_date))?> to <?=date('d M, Y', strtotime($row->event_end_date))?></td>
                  ...
                  <td class="v-align-middle"><?=get_event_participant_type($row->participant_type_id)?><br>
