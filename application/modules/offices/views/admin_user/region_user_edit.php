            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     ...
                     <a href="<?=base_url('offices/region_details/'.encrypt_url($info->sc_region_id))?>" class="btn btn-success btn-xs btn-mini"> Region Details</a>  
                     <a href="<?=base_url('offices/region_user/'.encrypt_url($info->sc_region_id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Region User List</a> 
                  </div>
               </div>
               <div class="grid-body">
                ...
                <div class="row form-row">
                     <div class="col-md-4">
                        ...
                        <h4 class="semi-bold" style="margin-top: 0;"> <?php echo $info->region_name_en?> </h4>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group">
                           <label class="form-label">Member Type <span class="required">*</span></label><br>
                           <input type="radio" class="m_type" name="member_type" value="1" id="sm" <?=set_value('member_type', $info->member_type)==1?'checked':'';?>> Scout Member
                     ...
                     <div class="col-md-4">
                        <div class="scoutMemberDiv">
                           ...
                           <!-- <input type="hidden" name="hide_region_id" id="hide_region_id" value="<?=$info->sc_region_id?>"> -->
                        </div>
                     </div>
                  </div>
