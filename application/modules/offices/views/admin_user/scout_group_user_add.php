               ...
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     <div class="col-md-4">
                        ...
                        <h4 class="semi-bold" style="margin-top: 0;"> <?=$info->grp_name != ''? $info->grp_name:$info->grp_name_bn?> </h4>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="scoutMemberDiv">
                           ...
                           <!-- <input type="hidden" name="hide_group_id" id="hide_group_id" value="<?=$info->id?>"> -->
                        </div>
                     </div>
                  </div>
