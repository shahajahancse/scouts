               ...
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     <div class="col-md-4">
                        ...
                        <h4 class="semi-bold" style="margin-top: 0;"> <?=$info->upa_name_en?> </h4>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="scoutMemberDiv">
                           ...
                           <?php /*
                           <input type="hidden" name="hide_upazila_id" id="hide_upazila_id" value="<?=$info->id?>">
                           <select class="scoutIDupazilaWiseSelect2 form-control input-sm" name="scout_member_id" id="scout_member_id" style="width: 100%;"></select>
                           */ ?>
                        </div>
                     </div>
                  </div>
