            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right" >                
                     ...
                     <a href="<?=base_url('offices/scout_group_details/'.encrypt_url($info->id))?>" class="btn btn-success btn-xs btn-mini"> Group Details</a>  
                     <a href="<?=base_url('offices/scout_group_user_add/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Group Admin User Add</a>  
                     <a href="<?=base_url('offices/scout_group_user_pdf/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini" target="_blank"> Group Admin User PDF</a>  
                  </div>
               </div>
               <div class="grid-body">
                        ...
                        <td align="right">
                           <div class="btn-group"> <a class="btn btn-primary dropdown-toggle btn-mini" data-toggle="dropdown" href="#"> Action <span class="caret"></span> </a>
                              <ul class="dropdown-menu pull-right">
                                 <li><a href="<?=base_url("offices/scout_group_user_edit/".encrypt_url($row->id))?>">Update</a></li>                             
                                 <li class="divider"></li>
                                 <li><a href="<?=base_url("offices/scout_group_user_delete/".encrypt_url($row->id).'/'.encrypt_url($info->id))?>" onclick="return confirm('Be careful! Are you sure you want to delete this scouts region?');">Delete</a></li>
                              </ul>
                           </div>
                        </td>                         
                     </tr>
