            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     ...
                     <a href="<?=base_url('offices/district_details/'.encrypt_url($info->sc_district_id))?>" class="btn btn-success btn-xs btn-mini"> District Details</a>  
                     <a href="<?=base_url('offices/district_user/'.encrypt_url($info->sc_district_id))?>" class="btn btn-blueviolet btn-xs btn-mini"> District User List</a> 
                  </div>
               </div>
               <div class="grid-body">
                ...
                <div class="row form-row">
                     <div class="col-md-4">
                        ...
                        <h4 class="semi-bold" style="margin-top: 0;"> <?php echo $info->dis_name_en?> </h4>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="scoutMemberDiv">
                           ...
                           <!-- <input type="hidden" name="hide_district_id" id="hide_district_id" value="<?=$info->sc_district_id?>"> -->
                        </div>
                     </div>
                  </div>
