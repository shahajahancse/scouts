            ...
            <div class="grid simple horizontal red">
               ...
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     ...
                     <h5 class="semi-bold margin_left_15">Example: ga_username</h5>
                     ...
                     <div class="col-md-4">
                        ...
                        <input name="identity" id="identity" type="text" value="<?=set_value('identity', $info->username)?>" class="form-control input-sm" placeholder="Example: ga_username" style="text-transform: lowercase; width: 300px;"> 
                     </div>
                  </div>                  
