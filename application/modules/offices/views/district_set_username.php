            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     <a href="<?=base_url('offices/district')?>" class="btn btn-blueviolet btn-xs btn-mini"> District List</a>  
                  </div>
               </div>
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     ...
                     <h4 class="semi-bold margin_left_15"> <?=$info->dis_name;?> </h4>
                     <div class="col-md-4">
                        ...
                        <input name="identity" id="identity" type="text" value="<?=set_value('identity', 'da_'.$this->input->post('identity'))?>" class="form-control input-sm" placeholder="Example: da_dhaka">
                     </div>
                     <div class="col-md-4">
