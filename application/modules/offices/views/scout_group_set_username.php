            ...
            <div class="grid simple horizontal red">
               ...
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     <h5 class="semi-bold margin_left_15">Create username, password for scouts group admin</h5>
                     ...
                     <div class="col-md-4">
                        ...
                        <input name="identity" id="identity" type="text" value="<?=set_value('identity', 'ga_'.$this->input->post('identity'))?>" class="form-control input-sm" placeholder="Example: ga_username" style="text-transform: lowercase;">
                     </div>
                     <div class="col-md-4">
