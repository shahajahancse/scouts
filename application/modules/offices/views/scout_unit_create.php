            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     ...
                     <a href="<?=base_url('offices/scout_group_details/'.$this->uri->segment(3))?>" class="btn btn-blueviolet btn-xs btn-mini"> Scout Group</a>
                  </div>
               </div>
               <div class="grid-body">
                  ...
                  echo form_open_multipart("offices/scout_unit_create/".$this->uri->segment(3), $attributes);?>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">                        
                        <div class="row form-row">
                           ...
                           <div class="col-md-5">
                              <label class="form-label"> Select Unit Leader </label>
