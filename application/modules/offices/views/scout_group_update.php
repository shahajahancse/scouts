            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     ...
                     <a href="<?=base_url('offices/scout_group_details/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Scout Group Details</a>  
                  </div>
               </div>
               <div class="grid-body">
                     ...
                     <div class="col-md-7">
                        ...
                        <div class="row form-row">
                           ...
                           <div class="col-md-6">
                              ...
                              <select class="scoutIDSingleSelect2 form-control" name="grp_leader" id="grp_leader"></select>
                              <?php
                              if($info->grp_leader){
                        ...
                        <div class="row form-row" id="groupWrap">
                           <div class="col-md-12">
                              <label class="form-label"> Search and Select Institute </label>
                     ...
                     <div class="row form-row">
                        ...
                        <div class="row form-row">
                           <div class="col-md-12">
                              ...
                              echo form_dropdown('grp_scout_dis_id', $district_dd, set_value('grp_scout_dis_id', $info->grp_scout_dis_id), $more_attr);
                              ?>
                        ...
                        <div class="row form-row">
                           <div class="col-md-12">                              
                              ...
                              echo form_dropdown('grp_scout_upa_id', $upazila_dd, set_value('grp_scout_upa_id', $info->grp_scout_upa_id), $more_attr);?>
                  ...
                  <div class="row" style="margin-bottom: 30px;">
                     ...
                     <h4 class="semi-bold margin_left_15">Scout Unit Modify <em style="color: #f73838; font-size: 15px;">Minimum 1 unit must be created. Click Add More or Remove button for modifying multiple units. </em></h4>
                     <hr>
                     <style type="text/css">
