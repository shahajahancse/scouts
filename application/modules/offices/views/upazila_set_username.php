<div class="page-content">     
   <div class="content">  
      <ul class="breadcrumb">
         ...
         <li> <a href="<?=base_url('offices/upaila')?>" class="active"><?=$module_name?> </a> </li>
         <li><?=$meta_title; ?></li>
      </ul>
            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     <a href="<?=base_url('offices/upazila')?>" class="btn btn-blueviolet btn-xs btn-mini"> Upazila List</a>  
                  </div>
               </div>
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     ...
                     <h4 class="semi-bold margin_left_15"> <?=$info->upa_name;?> </h4>
                     <div class="col-md-4">
                        ...
                        <input name="identity" id="identity" type="text" value="<?=set_value('identity', 'ua_'.$this->input->post('identity'))?>" class="form-control input-sm" placeholder="Example: ua_dhaka" style="text-transform: lowercase;">
                     </div>
                     <div class="col-md-4">
