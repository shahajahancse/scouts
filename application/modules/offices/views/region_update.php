                     ...
                     <div class="col-md-7">
                        <div class="row form-row">
                           <div class="col-md-6">
                              ...
                              echo form_dropdown('region_div_id', $divisions, set_value('region_div_id', $info->region_div_id), $more_attr);
                              ?>
                           </div>
                           <div class="col-md-6">
                              ...
                              $more_attr = 'class="form-control input-sm"';
                              echo form_dropdown('region_type', $region_type, set_value('region_type', $info->region_type), $more_attr);
                              ?>
                           </div>
                        </div>
                        ...
                        <div class="row form-row">
                           ...
                           <div class="col-md-12">
                              ...
                              <input name="region_name_en" id="region_name_en" value="<?=set_value('region_name_en', $info->region_name_en)?>" type="text" class="form-control input-sm" placeholder="">
                           </div>
                        </div>
                        ...
                        <div class="row form-row">
                           <div class="col-md-12">
                              ...
                              <textarea name="region_description" class="form-control" rows="10"><?=set_value('region_description', $info->region_description)?></textarea>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-5">
                        <div class="row form-row">
                           ...
                           <div class="col-md-6">
                              ...
                              <input name="region_fax" id="region_fax" value="<?=set_value('region_fax', $info->region_fax)?>" type="text" class="form-control input-sm" placeholder="">
                           </div>
                        </div>
                        <div class="row form-row">
                           <div class="col-md-12">
