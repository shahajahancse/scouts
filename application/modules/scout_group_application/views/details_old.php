        ...
        <div class="grid simple ">
          ...
          <div class="grid-body ">
            ...
            <div class="tiles white details">
              <a href="<?=base_url('Complain/details_pdf'.'/'.encrypt_url($info->id))?>" class="btn btn-primary btn-xs btn-mini" style="float: right;">PDF Download</a>
                <table class="tg">
                    <tr>
                      <th class="tg-9vst">Name:</th>
                      <td class="tg-031e" width="300"><?=$info->name?></td>
                      <th rowspan="4" class="tg-9vst">Problem Details:</th>
                      <td rowspan="4" class="tg-031e" valign="top"><?=$info->complain_details?></td>
                    </tr>
                    <tr>
