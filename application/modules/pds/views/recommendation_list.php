            ...
            <div class="grid simple ">
               <div class="grid-title">
                  ...
                  <div class="pull-right">
                     ...
                     <?php } ?>
                     <a href="<?=base_url('award/recommendation_approve_list_pdf/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Generate Award Approve PDF List</a>
                  </div>            
               </div>
                           ...
                           <td align="right">
                              <div class="btn-group"> <a class="btn btn-primary dropdown-toggle btn-mini" data-toggle="dropdown" href="#"> Action <span class="caret"></span> </a>
                                 <ul class="dropdown-menu pull-right">
                                    ...
                                    <li><a href="<?=base_url('award/recommendation_status/'.encrypt_url($row->id))?>">Approval Status</a></li>
