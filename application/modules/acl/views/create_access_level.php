       ...
       <div class="col-md-12">
          <div class="grid simple horizontal red">
             ...
             <div class="grid-body">
              ...
              <?php endif; ?>
              <?php echo form_open("acl/create_access_level");?>
              ...
              <div class="row form-row">
                <div class="col-md-4">
                  ...
                  <?php 
                    ...
                    echo form_dropdown('task_register_id', $task_register, set_value('task_register_id', $this->input->post('task_register_id')), $more_attr);
                  ?>
                </div>
                <div class="col-md-4">
                  ...
                  <?php 
                    $more_attr = 'class="select2 form-control"';
                    echo form_dropdown('groups_id', $groups, set_value('groups_id', $this->input->post('groups_id')), $more_attr);
                  ?>
                </div>
                <div class="col-md-4">
                  ...
                  <?php 
                    $more_attr = 'class="select2 form-control"';
                    echo form_dropdown('groups_type_id', $groups_type, set_value('groups_type_id', $this->input->post('groups_type_id')), $more_attr);
                  ?>
                </div>
              </div>
