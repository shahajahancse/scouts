        ...
        <div class="grid simple horizontal green">
          <div class="grid-title">
            ...
            <div class="pull-right">
              <a href="<?=base_url('acl/create_access_level')?>" class="btn btn-primary btn-xs btn-mini"> Create Access Level</a>  
            </div>            
          </div>
            ...
            <table class="table table-hover table-bordered  table-flip-scroll cf">
                ...
                ?>
                    <tr>
                      ...
                      <td><?php echo anchor("acl/edit_access_level/".$row->id, 'Edit','class="btn btn-mini btn-primary"') ;?>&nbsp;<a class="btn btn-mini btn-primary" href="#">Delete</a></td>
                      <?php /*?><td>
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                            <li><?php echo anchor("acl/edit_access_level/".$row->id, 'Edit') ;?></li>
                            <li class="divider"></li>
