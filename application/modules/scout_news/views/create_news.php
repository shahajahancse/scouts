    ...
    <div class="row">
     <div class="col-md-12">
      ...
      <div class="grid-body">
        ...
        echo form_open_multipart("scout_news/create_news", $attributes);
        ?>
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="row form-row">
              <div class="col-md-10">
                <label class="form-label">News Title<span class="required">*</span></label>
                <?php echo form_error('news_title'); ?>
                <input name="news_title" id="news_title" type="text" class="form-control input-sm" value="<?=set_value('news_title')?>">
              </div>
            </div>
            ...
            <div class="row form-row">
              <div class="col-md-10">
                ...
                <textarea name="news_details" rows="10" cols="70"><?=set_value('news_details')?></textarea>
              </div>                    
            </div>
