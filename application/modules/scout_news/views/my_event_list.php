                ...
                <?php if(!empty($event)){
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="<?=base_url('events/details/'.$row->id);?>" class="btn btn-primary btn-xs btn-mini">Details</a>     
                      <?php if($row->comments==NULL){?>
                        <a href="<?=base_url('events/comments/'.$row->id);?>" class="btn btn-info btn-xs btn-mini">Feedback</a>
                      <?php } ?>
                    </td>
                  </tr>
                    <?php
