            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     <a href="<?=base_url('scouts_member/details/'.$id)?>" class="btn btn-blueviolet btn-xs btn-mini"> Scouts Member Details</a>  
                  </div>
               </div>
                                       ...
                                       <h5><span class="semi-bold">দীক্ষা / ব্যাজ অর্জনের </span></h5>
                                          ...
                                          <div class="row form-row">
                                             ...
                                             <div class="col-md-5">
                                                ...
                                                ?>
                                                <select class="scoutIDSingleSelect2 form-control" name="examiner_id" id="achiev_examiner_id"></select>
                                             </div>
