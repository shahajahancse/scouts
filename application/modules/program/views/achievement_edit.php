                  ...
                  <div class="col-md-12">
                     <div class="row form-row">
                        <div class="col-md-4">
                           ...
                           echo form_dropdown('badge_id', $badges, set_value('badge_id', $infoAchiev->badge_id), $more_attr);
                           ?>
                        </div>
                        <div class="col-md-3">  
                           <label class="form-label">Achieved Date <span class="required">*</span></label>
                           <?php echo form_error('achive_date'); ?>
                           <input type="text" name="achive_date" id="achiev_achive_date" class="form-control input-sm datetime" value="<?=set_value('achive_date', date_browse_format($infoAchiev->achive_date))?>" placeholder="DD-MM-YYYY">
                        </div>
                        <div class="col-md-4">
                           ...
                           <script>
                              var $newOption = $("<option></option>").val("<?php echo $infoAchiev->examiner_id;?>").text("<?php echo $infoAchiev->scout_id.' ('.$infoAchiev->first_name.')'?>");
                              $("#achiev_examiner_id").append($newOption).trigger('change');
                           </script>
                        </div>
                     </div>
