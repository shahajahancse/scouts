         ...
         <div class="col-md-12">
            <div class="grid simple horizontal red">
              ...
              <div class="grid-body">              
               ...
               echo form_open("program/promotion_add/".encrypt_url($info->id), $attributes);?>
                  ...
                  <div class="col-md-12">
                     ...
                     <?php if($info->sc_section_id == 3 || $info->member_id == 8 || $info->member_id == 9 || $info->member_id == 10 || $info->member_id == 12){ ?>
                        <div class="col-md-3">
                           ...
                           <input type="radio" name="promo_office_type" class="sc_office" value="1" <?=set_value('promo_office_type')=='1'?'checked':'';?> checked> NHQ Office
                           <input type="radio" name="promo_office_type" class="sc_office" value="2" id="officeOther" <?=set_value('promo_office_type')=='2'?'checked':'';?>> Other Office
                        </div>      
                        ...
                        <div class="col-md-3 otherOffice" >
                           ...
                           echo form_dropdown('promo_region_id', $regions, set_value('promo_region_id'), $more_attr);
                           ?>
                        </div>
                     ...
                     <?php }else{ ?>
                        ...
                        <div class="col-md-6 otherOffice">
                           ...
                           <?php echo form_error('promo_gorup_id');?>
                           <select class="scoutsGroupSelect2 form-control" name="promo_gorup_id" id="sc_unit_list" style="width:100%;"></select>
                        </div>
                        <div class="col-md-6 otherOffice">
                           <label class="form-label">Scouts Unit </label>
                           <?php echo form_error('promo_unit_id');?>
                     ...
                     <div class="row form-row">
                        <div class="col-md-3">
                           ...
                           echo form_dropdown('promo_member_id',$member_type, set_value('promo_member_id'), $more_attr);?>
                        </div>
                        <div class="col-md-3">
                           ...
                           echo form_dropdown('promo_section_id', $scout_section, set_value('promo_section_id'), $more_attr);
                           ?>
                        </div>
                        <div class="col-md-3" id="sc_role_hidden">
                           ...
                           <select name="promo_role_id" class="sc_role_val form-control input-sm">
                              <option value="">-- Select One --</option>
                           </select>
                        </div>                        
                     </div>
                     ...
                     <div class="row form-row">
                        <div class="col-md-3">  
                           ...
                           <input type="text" name="promo_start_date" class="form-control input-sm datetime" value="<?=set_value('promo_start_date')?>" placeholder="DD-MM-YYYY">
                        </div>
                        <div class="col-md-2">
                          <label class="form-label">End Date </label>
                          <?php echo form_error('promo_end_date'); ?>
                          <input type="text" name="promo_end_date" class="form-control input-sm datetime" value="<?=set_value('promo_end_date')?>" placeholder="DD-MM-YYYY">
                       </div>
                       <div class="col-md-4">
                           <label class="form-label">Departments </label>
                           <?php echo form_error('promo_department_id');
                           $more_attr = 'class="form-control input-sm"';
                           echo form_multiselect('promo_department_id[]', $departments, set_value('promo_department_id'), $more_attr);
                           ?>
                        </div>
                    </div>
