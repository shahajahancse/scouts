         ...
         <div class="col-md-12">
            <div class="grid simple horizontal red">
               ...
               <div class="grid-body">              
                  ...
                  echo form_open("program/award_add/".encrypt_url($info->id), $attributes);?>
                     ...
                     <div class="col-md-12">
                        <div class="row form-row">
                           <div class="col-md-7">
                              ...
                              <input type="text" name="award_name" class="form-control input-sm" value="<?=set_value('award_name')?>" placeholder="">
                           </div>
                           <div class="col-md-3">  
                              <label class="form-label">Certificate No <span class="required">*</span></label>
                              <?php echo form_error('certificate_no'); ?>
                              <input type="text" name="certificate_no" class="form-control input-sm" value="<?=set_value('certificate_no')?>" placeholder="">
                           </div>
                        </div>
                        <div class="row form-row">
                           <div class="col-md-3">  
                           ...
                           <div class="col-md-7">
                              ...
                              <input type="text" name="issue_authority" class="form-control input-sm" value="<?=set_value('issue_authority')?>" placeholder="">
                           </div>
                        </div>
