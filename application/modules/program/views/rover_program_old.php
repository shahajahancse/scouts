                     ...
                     <div class="col-md-12">
                        <div class="tabbable tabs-left">
                           <ul class="nav nav-tabs" id="tab-2">
                              ...
                              <li><a href="#tab_section_promotion">রোভার স্কাউট পদোন্নতি</a></li>
                           ...
                           <div class="tab-content">
                              ...
                              <?php endif; ?>
                                 ...
                                 <!-- <div class="tab-pane" id="tab_badge">                                 
                                    <div class="row ">
                                       <div class="col-md-12">
                                       <h5><span class="semi-bold">রোভার স্কাউটস ব্যাজ বিবরণ</span></h5>
                                          <?php 
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                   ...
                                                   <h5><span class="semi-bold">রোভার স্কাউট ব্যাজ অর্জনের বিবরণ</span></h5>
