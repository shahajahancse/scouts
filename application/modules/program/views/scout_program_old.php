                     ...
                     <div class="col-md-12">
                        <div class="tabbable tabs-left">
                           <ul class="nav nav-tabs" id="tab-2">
                              ...
                              <li><a href="#tab_section_promotion">স্কাউট পদোন্নতি</a></li>
                              ...
                              <li ><a href="#tab_badge">স্কাউটস ব্যাজ বিবরণ</a></li> -->
                           </ul>
                           <div class="tab-content">
                              ...
                              <?php endif; ?>                                 
                                 ...
                                 <div class="tab-pane active" id="tab_achievement">
                                    <div class="row ">
                                       <div class="col-md-12">
                                       <h5><span class="semi-bold">দীক্ষা / ব্যাজ অর্জনের </span></h5>
                                          <?php 
                                          $attributes = array('id' => 'program_badge_achievemen');
                                          ...
                                          <div class="row form-row">
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                //$more_attr = 'class="form-control input-sm" id="achiev_examiner_id"';
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                   ...
                                                   <h5><span class="semi-bold">দীক্ষা / ব্যাজ অর্জনের ও
                                                    বিবরণ</span></h5>
                                 ...
                                 <div class="tab-pane" id="tab_expartness">
                                    <div class="row ">
                                       ...
                                       <h5><span class="semi-bold">পারদর্শিতা ব্যাজ অর্জন</span></h5>
                                          <?php 
                                          $attributes = array('id' => 'program_badge_expertness');
                                          echo form_open("", $attributes);?>
                                          <div class="row form-row">
                                             <div class="col-md-4">
                                                <label class="form-label">ব্যাজ</label>
                                          ...
                                          <div class="row form-row">
                                             <div class="col-md-4">  
                                                ...
                                                <?php echo form_error('achive_date'); ?>
                                                <input type="text" name="achive_date" id="ex_achive_date" class="form-control input-sm datetime" value="<?=set_value('achive_date')?>" placeholder="DD-MM-YYYY">
                                             </div>
                                             
                                             <div class="col-md-6">
                                                <label class="form-label">মূল্যায়নকারী</label>
                                                <?php echo form_error('examiner_id');
                                                //$more_attr = 'class="form-control input-sm" id="ex_examiner_id"';
                                                //echo form_dropdown('examiner_id', $scout_members, set_value('examiner_id'), $more_attr);
                                                ?>
                                                <select class="scoutIDSingleSelect2 form-control" name="examiner_id" id="ex_examiner_id" style="width:100%"></select>
                                             </div>
                                             <div class="col-md-1">  
                                                <label class="form-label">&nbsp;</label>
                                                <button type="submit" class="btn btn-primary btn-mini mini-btn-padding">Save</button>
                                 ...
                                 <div class="tab-pane" id="tab_section_promotion">
                                    <div class="row ">
                                       <div class="col-md-12">
                                       <h5><span class="semi-bold">স্কাউট পদোন্নতি </span></h5>
                                          <?php 
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                   ...
                                                   <h5><span class="semi-bold">স্কাউট পদোন্নতির
                                                    বিবরণ</span></h5>
                                 ...
                                 <!-- <div class="tab-pane" id="tab_badge">                                 
                                    <div class="row ">
                                       <div class="col-md-12">
                                       <h5><span class="semi-bold">স্কাউটস ব্যাজ বিবরণ</span></h5>
                                          <?php 
                                          $attributes = array('id' => 'program_badge');
                                          echo form_open("", $attributes);?>
                                          <div class="row form-row">
                                             <div class="col-md-3">
                                                <label class="form-label">ব্যাজ</label>
                                             ...
                                             <div class="col-md-3">  
                                                ...
                                                <?php echo form_error('achive_date'); ?>
                                                <input type="text" name="achive_date" id="achive_date" class="form-control input-sm datetime" value="<?=set_value('achive_date')?>" placeholder="DD-MM-YYYY">
                                             </div>
                                             <div class="col-md-2">
                                                <label class="form-label">মূল্যায়নকারী</label>
                                                <?php echo form_error('examiner_id');
                                                $more_attr = 'class="form-control input-sm" id="examiner_id"';
                                                echo form_dropdown('examiner_id', $scout_members, set_value('examiner_id'), $more_attr);
                                                ?>
                                             </div>
                                             <div class="col-md-1">  
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                   ...
                                                   <h5><span class="semi-bold">স্কাউট ব্যাজ অর্জনের বিবরণ</span></h5>
                                 ...
                                 <!-- <div class="tab-pane" id="tab_physical_health">
                                    <div class="row ">
                                       ...
                                       <h5><span class="semi-bold">দৈহিক ও স্বাস্থ্যগত রেকর্ড</span></h5>
                                          <?php 
                                          $attributes = array('id' => 'program_badge_health');
                                          echo form_open("", $attributes);?>
                                          <div class="row form-row">
                                             <div class="col-md-2">
                                          ...
                                          <div class="row form-row">
                                             ...
                                             <div class="col-md-4">
                                                <label class="form-label">মূল্যায়নকারী</label>
                                                <?php echo form_error('examiner_id');
                                                $more_attr = 'class="form-control input-sm" id="health_examiner_id"';
                                                echo form_dropdown('examiner_id', $scout_members, set_value('examiner_id'), $more_attr);
                                                ?>
                                             </div> 
                                 ...
                                 <!-- <div class="tab-pane" id="tab_institute_promotion">
                                    <div class="row ">
                                       ...
                                       <h5><span class="semi-bold">বিদ্যালয়ের ক্রমোন্নতি তথ্য</span></h5>
                                          <?php 
                                          $attributes = array('id' => 'program_badge_institute');
                                          echo form_open("", $attributes);?>
                                          <div class="row form-row">
                                             <div class="col-md-2">
                                                <label class="form-label">বর্ষ</label>
                                             ...
                                             <div class="col-md-3">
                                                <label class="form-label">মূল্যায়নকারী</label>
                                                <?php echo form_error('examiner_id');
                                                $more_attr = 'class="form-control input-sm" id="institute_examiner_id"';
                                                echo form_dropdown('examiner_id', $scout_members, set_value('examiner_id'), $more_attr);
                                                ?>
                                             </div> 
