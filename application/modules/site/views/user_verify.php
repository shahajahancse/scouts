...
<div class="container w-75">
  <div class="secondary_sc_content">
    ...
    <?php $attributes = array('id' => 'infovalidation', 'method' => 'get'); echo form_open("user-verify", $attributes); ?>
      <div class="container">
        ...
        <div class="row result">
          <div class="col-md-6">
            <div class="form-group">
              <label style="font-weight:bold;"><?=lang('site_user_id')?>*</label>
              <?php echo form_error('scoutID'); ?>
              <input type="text" name="scoutID" class="form-control" value="<?=set_value('scoutID', $this->input->get('scoutID'))?>" id="scoutID" placeholder="" style="text-transform: uppercase;">
            </div>
          </div>
              ...
              <?php if(!empty($result)){ ?>
                <?php
                  if($this->session->userdata('site_lang')=='bangla'){
                    ...
                    $pre_division = $result->pre_div_name_bn;
                    $pre_district = $result->pre_district_name_bn;
                    $pre_up_th    = $result->pre_up_th_name_bn;
                ...
                ?>
                <h5><?=lang('site_user_search_status')?> </h5><hr>
