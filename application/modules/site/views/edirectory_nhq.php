            ...
            <div class="row">
              ...
              <tbody>
                 <?php 
                    ...
                    ?>
                    <tr>
                       <td width="5%"><a href="<?=base_url('edirectory-nhq-listing/'.$row->id)?>"><?=$row->committee_designation_name_en?> (<?=$count_contact?>)</a></td>
                    </tr>
                    <?php } ?>      
                 </tbody>
              </table>
              ...
              <!-- <form action="" method="get" id="validation">
                ...
                <div class="row form-row">
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-xs-12 text-center">
