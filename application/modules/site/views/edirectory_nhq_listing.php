              ...
              <?php if(!empty($results)){ ?>
                ...
                foreach ($results as $row) { 
                  ...
                  if($row->scout_id != NULL){
                    $img_url = '<img src="'.base_url('profile_img/'.$row->profile_img).'" height="70" width="70" style="min-height: 70px;">';
                  }elseif($row->image_file != NULL){
                    $img_url = '<img src="'.base_url('uploads/edirectory_img/'.$row->image_file).'" height="70" width="70" style="min-height: 70px;">';
                  }else{
                    $img_url = '<img src="'.base_url('uploads/edirectory_img/no-image.jpg').'" height="70" width="70" style="min-height: 70px;">';
                  }
                  ?>
                  <div class="col-md-6">
