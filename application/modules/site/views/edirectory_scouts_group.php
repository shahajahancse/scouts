    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
     ...
     <div class="container">
      ...
      <ul class="nav nav-tabs">
       <li class="nav-item">
         <a class="nav-link active" data-toggle="tab" href="#basic">Scouts Group Designation</a>
       </li>
     </ul>
     ...
     <div class="tab-content">
       <div class="tab-pane container active" id="basic">
        ...
        <tr>
          ...
          <td class="tg-031e"><?=$info->grp_url?></td>
        </tr>
      </table>
      <div class="pt-3"></div>
      ...
      ?>
        <tr>
         <td width="5%"><a href="<?=base_url('edirectory-sgroup-listing/'.$info->id.'/'.$row->id)?>"><?=$row->committee_designation_name_en?>  (<?=$count_contact?>)</a></td>
       </tr>
       <?php } ?>      
     </tbody>
   </table>
