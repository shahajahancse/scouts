   ...
   <div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
     <div class="container">
      ...
      <ul class="nav nav-tabs">
       <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#basic">Region Designation</a>
      </li>
      <li class="nav-item">
    ...
    <div class="tab-content">
     <div class="tab-pane container active" id="basic">
      ...
      <tr>
        ...
        <td class="tg-031e"><?=$info->region_url?></td>
      </tr>
    </table>
    <div class="pt-3"></div>
    ...
    <table class="table table-bordered">
     <tbody>
      ...
      ?>
      <tr>
       <td width="5%"><a href="<?=base_url('edirectory-region-listing/'.$info->id.'/'.$row->id)?>"><?=$row->committee_designation_name_en?>  (<?=$count_contact?>)</a></td>
     </tr>
     <?php } ?>      
   </tbody>
 </table>
  ...
  <table class="table table-bordered">
   ...
   foreach ($office_list as $row) { 
     ...
     <tr>
      ...
      <td><a href="<?=base_url()?>edirectory-district/<?=$row->id?>" style="color:#000;"><?=$row->$lan?></a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
