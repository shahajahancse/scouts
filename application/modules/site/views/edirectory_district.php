  ...
  <div class="secondary_sc_content">
   ...
   <?php $this->load->view('edirectory_filter'); ?>
     <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
       ...
       <div class="container">
        ...
        <ul class="nav nav-tabs">
         <li class="nav-item">
           <a class="nav-link active" data-toggle="tab" href="#basic">District Designation</a>
         </li>
         <li class="nav-item">
       ...
       <div class="tab-content">
        <div class="tab-pane container active" id="basic">
         <h5 class="tab_heading"> Basic Information about the District </h5>
         <table class="tg">
          <tr>
         ...
         <tr>
          ...
          <td class="tg-031e"><?=$info->dis_url?></td>
        </tr>
       </table>
       <div class="pt-3"></div>
      ...
      ?>
         <tr>
          <td width="5%"><a href="<?=base_url('edirectory-district-listing/'.$info->id.'/'.$row->id)?>"><?=$row->committee_designation_name_en?>  (<?=$count_contact?>)</a></td>
        </tr>
        <?php } ?>      
      </tbody>
    </table>
    ...
    <table class="table table-bordered">
     ...
     foreach ($office_list as $row) { 
      ...
      <tr>
        ...
        <td><a href="<?=base_url()?>edirectory-upazila/<?=$row->id?>" style="color:#000;"><?=$row->$lan?></a></td>
      </tr>
      <?php } ?>
    </tbody>
  </table>
