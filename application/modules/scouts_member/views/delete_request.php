      ...
      <div class="span12">
        <div class="grid simple ">
          ...
          <div class="grid-body ">
            ...
            <!-- Pdf or Doc file download link -->
            <div class="download-buttons">
              <!--  <a href="<?=base_url('scouts_member/delete_request_doc')?>" class="btn btn-blueviolet btn-xs btn-mini">DOC Download</a> -->
              <a href="<?=base_url('scouts_member/delete_request_pdf')?>" class="btn btn-primary btn-xs btn-mini">PDF Download</a>
            </div>
