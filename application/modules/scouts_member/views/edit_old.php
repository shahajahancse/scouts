         ...
         <div class="col-md-12">
            <div class="grid simple horizontal red">
               ...
               <div class="grid-body">
                  ...
                  echo form_open_multipart("scouts_member/edit/".$info->id, $attributes);?>
                     ...
                     <div class="col-md-7">
                        ...
                        <div class="row form-row">
                           ...
                           <div class="col-md-6">
                              ...
                              <input type="text" name="father_name_bn" class="form-control input-sm" value="<?=set_value('father_name_bn', $info->father_name_bn)?>">
                           </div>
                        </div>
                        ...
                        <div class="row form-row">
                           ...
                           <div class="col-md-6">
                              ...
                              <input type="text" name="mother_name_bn"  class="form-control input-sm" value="<?=set_value('mother_name_bn',$info->mother_name_bn)?>">
                           </div>
                        </div>
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="row form-row">
                           <div class="col-md-6">
                              ...
                              <input name="passport_no" value="<?=set_value('passport_no', $info->passport_no)?>" type="text" class="form-control input-sm" placeholder="">
                           </div>
                           <div class="col-md-6">
                              <label class="form-label">Email</label>
                              <?php echo form_error('email'); ?>
                              <input name="email" value="<?=set_value('email', $info->email)?>" type="text" class="form-control input-sm" placeholder="xyz@example.com">
                           </div> 
                        </div>
                        ...
                        <div class="row form-row">
                           <div class="col-md-6">
                              ...
                              <input name="facebook" value="<?=set_value('facebook', $info->facebook)?>" type="text" class="form-control input-sm" placeholder="https://...">
                           </div>  
                           <div class="col-md-6">
                              <label class="form-label">Google+</label>
                              <?php echo form_error('google'); ?>
                              <input name="google" value="<?=set_value('google', $info->google)?>" type="text" class="form-control input-sm" placeholder="https://...">
                           </div>
                           <div class="col-md-6">
                              <label class="form-label">Linkedin</label>
                              <?php echo form_error('linkedin'); ?>
                              <input name="linkedin" value="<?=set_value('linkedin', $info->linkedin)?>" type="text" class="form-control input-sm" placeholder="https://...">
                           </div> 
                           <div class="col-md-6">
                              <label class="form-label">Skype</label>
                              <?php echo form_error('skype'); ?>
                              <input name="skype" value="<?=set_value('skype', $info->skype)?>" type="text" class="form-control input-sm" placeholder="https://...">
                           </div> 
                        </div>
                     </div> 
                  </div>
                  ...
                  <div class="row">          
                     <div class="col-md-12">        
                      ...
                      <div class="col-md-12">
                       <input type="radio" class="is_interested" name="is_interested" value="0" <?=$info->is_interested=='0'?'checked':'';?>> <span style="color: black; font-size: 14px;">I am already a scout Member</span>  &nbsp; &nbsp;  
                       <input type="radio" class="is_interested" name="is_interested" value="1" <?=$info->is_interested=='1'?'checked':'';?>> <span style="color: black; font-size: 14px;">I am interested</span>
                    </div>
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div class="row form-row"> 
                           <div class="col-md-12">
                              <label class="form-label">Currnet Institute <?php echo $info->institute_name;?></label>
                              <?php echo form_error('curr_institute_id');
                              //$more_attr = 'class=" form-control input-sm" ';
                              //echo form_dropdown('curr_institute_id', $institute, set_value('curr_institute_id', $info->curr_institute_id), $more_attr);
                              ?>
                              <!-- <select class="scoutIDselect2 form-control input-sm" id="scoutMember<?php //echo $row->member_scout_id;?>" name="member_scout_id[]"></select> -->
                     ...
                     <div class="col-md-8">
                        ...
                        <div class="row form-row">
                           <div class="col-md-4">
                              ...
                              <input name="join_date" value="<?=set_value('join_date', date_browse_format($info->join_date))?>" type="text" class="form-control input-sm datetime pull-left" placeholder="DD-MM-YYYY" style="width: 80%;">
                        ...
                        <div class="row form-row">
                           <div class="col-md-6">
                              ...
                              echo form_dropdown('sc_upa_tha_id', $scout_upazila_thana, set_value('sc_upa_tha_id', $info->sc_upa_tha_id), $more_attr);
                              ?>
                           </div>
                           <div class="col-md-6">
                  ...
                  <div class="row form-row">
                     ...
                     <?php if($this->ion_auth->is_admin() || $this->ion_auth->is_region_admin() || $this->ion_auth->is_district_admin() || $this->ion_auth->is_upazila_admin() || $this->ion_auth->is_group_admin()): ?>
                           <!-- <div class="col-md-6"> -->
                              <div class="form-group">
                                 <h4 style="font-weight: bold;">Scout Member Group Access</h4>
                                 <?php foreach ($groups as $group):?>
                                    <div style="color: black;">
                                       <?php
                                       $gID=$group['id'];
                                       if(!in_array($gID, $access)){continue;}
                                       $checked = null;
                                       $item = null;
            ...
            <div class="form-actions">  
               <div class="pull-right">
                  <button type="submit" class="btn btn-primary btn-cons"><i class="icon-ok"></i> Update Scout Member</button>
               </div>
            </div>
            <?php echo form_close();?>
