        ...
        <div class="grid simple ">
          ...
          <div class="grid-body ">
            ...
            <div class="download-buttons">
              <a href="<?=base_url('scouts_member/archive_list_doc')?>" class="btn btn-blueviolet btn-xs btn-mini">DOC Download</a>
              <a href="<?=base_url('scouts_member/archive_list_pdf')?>" class="btn btn-primary btn-xs btn-mini">PDF Download</a>
            </div>
