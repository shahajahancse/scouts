      ...
      <div class="span12">
        <div class="grid simple ">
          ...
          <div class="grid-body ">
            ...
            <a href="<?=base_url('scouts_member/archive_list_doc')?>" class="btn btn-blueviolet btn-xs btn-mini" style="float: right;margin-left: 10px;">DOC Download</a>

            <a href="<?=base_url('scouts_member/archive_list_pdf')?>" class="btn btn-primary btn-xs btn-mini" style="float: right;">PDF Download</a>
