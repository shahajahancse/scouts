...
<body>
  ...
  <div style="float: left;border: 0px solid red; width: 800px; margin:10px 30px 0 80px; padding-top: 10px; ">
    ...
    <div style="border: 0px solid black; margin: 0px 0 0 0px; font-size: 30pt;color: black; font-family: arial;font-weight: bold;"><?=$father?></div>
    ...
    <div style="border: 0px solid black; margin: 0px 0 0 0px; font-size: 30pt;color: black;  font-family: arial;font-weight: bold;"><?=$mother?></div>
    ...
    <div style="border: 0px solid black; margin: 0px 0 0 0px; height: 60px; font-size: 30pt;color: black;  font-family: arial;font-weight: bold;"><?=$phone?></div>
  ...
  <div style="float: left;border: 0px solid yellow; width: 400px;">
