...
<body>
  ...
  <div style="float: left;border: 0px solid yellow; position: absolute;">
    ...
    <div style="height: 535px;">
      <div style="border:0px solid black; margin: 90px 0 0 0px; width: 230mm; font-size: 40pt;color: black; font-family: arial;font-weight: bold;"><?=$name?></div>
      ...
      <div style="border: 0px solid black; margin: 10px 0 0 0px; width: 230mm; font-size: 30pt;color: blue; font-family: arial;font-weight: bold;"><?=$sc_group_name?></div>
