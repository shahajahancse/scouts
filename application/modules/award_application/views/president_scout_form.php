   ...
   <style type="text/css">
    ...
    <div class="row">
       <div class="col-md-12">
          <div class="grid simple horizontal red">
             <div class="grid-title">
              ...
              <div class="pull-right">
                <a href="javascript:void();" class="btn btn-default btn-xs btn-mini" data-toggle="modal" data-target="#myModal"> প্রসিডেন্ট'স স্কাউট অ্যাওয়ার্ড সুপারিশ ফরম প্রদানের নিয়মাবলী</a>  
              </div>
             </div>
             <div class="grid-body">
          ...
          <?php 
          $attributes = array('id' => '');
          echo form_open("award_application/president_scout_form", $attributes);?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 id="myModalLabel" class="semi-bold">প্রসিডেন্ট'স স্কাউট অ্যাওয়ার্ড সুপারিশ ফরম পূরণ, মূল্যায়ন ও ফলাফল প্রদানের নিয়মাবলী</h4>
        <p class="no-margin">
          প্রসিডেন্ট'স স্কাউট অ্যাওয়ার্ড সুপারিশ ফরম পূরণ, মূল্যায়ন ও ফলাফল প্রদানের নিয়মাবলী      
        </p>
        <br>
      </div>
