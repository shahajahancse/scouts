        ...
        <div class="grid simple ">
          <div class="grid-title">
            ...
            <div class="pull-right btn-group-responsive">
              <a href="<?=base_url('services/request_list')?>" class="btn btn-blueviolet btn-xs btn-mini"> Request List </a>
          ...
          <div class="grid-body">
            ...
            <div class="text-right pdf-download">
              <a href="<?=base_url('Services/on_process_list_pdf')?>" class="btn btn-primary btn-xs btn-mini">PDF Download</a>
            </div>
            ...
            <div class="pagination-stats">
              <div>Total <span style="color: green; font-weight: bold;"><?php echo $total_rows; ?> Request </span></div>
              <div><?php echo $pagination['links']; ?></div>
            </div>
