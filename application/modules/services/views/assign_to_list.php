        ...
        <div class="grid simple ">
          ...
          <div class="grid-body ">
            ...
            <div class="text-right pdf-download">
              <a href="<?=base_url('Services/assign_to_list_pdf')?>" class="btn btn-primary btn-xs btn-mini">PDF Download</a>
            </div>
          ...
          <div class="row">
            <div class="col-sm-4 col-md-4 text-left pagination-stats"> Total <span style="color: green; font-weight: bold;"><?php echo $total_rows; ?> Record </span></div>
