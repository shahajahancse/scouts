        ...
        <div class="tiles white">
          <div class="row">
            ...
            <div class="col-md-12 user-description-box col-sm-12 ">
                ...
                <?php endif; ?>
                <?php if(($user->emp_designation < 8) && ($user->emp_designation == $suggestion->nathi_desk) && ($suggestion->nathi_approval !=1)):?>
                    <a href="<?=base_url('e_nathi/approved/'.$suggestion->id) ?>" class="btn btn-info pull-right" style="margin-left: 15px">অনুমোদন প্রদান</a>
                <?php endif; ?>

                <?php if(($user->emp_designation >=9) && ($user->emp_designation == $suggestion->nathi_desk) && ($suggestion->status == 1)):?>
                    <a href="<?=base_url('e_nathi/closing/'.$suggestion->id) ?>" class="btn btn-info pull-right" style="margin-left: 15px">সম্পন্ন করুন</a>
                <?php endif; ?>

                <?php if(($user->emp_designation == $suggestion->nathi_desk && ($suggestion->status == 1) && ($suggestion->nathi_approval !=1)) OR $this->ion_auth->is_admin()):?>
                      ...
                      <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                        <div class="modal-dialog modal-sm" role="document">
                          <div class="modal-content">
                            ...
                            echo form_open_multipart(base_url('e_nathi/forward/'.$suggestion->id), $attributes);?>
                            <?php
                              if($suggestion->nathi_approval==1){
                                $next_step=10;
                              }elseif($user->emp_designation==10){
                                $next_step=8;
                              }elseif($user->emp_designation==7){
                                $next_step=5;
                              }else{
                                $next_step=$user->emp_designation-1;
                              }
                            ?>
                      ...
                      <!-- Small modal -->
                      <button type="submit" class="btn btn-primary pull-right" data-toggle="modal" data-target=".bs-example-modal-sm" style="margin-right: 15px">মন্তব্য এবং স্বাক্ষর</button>

                      <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                        <div class="modal-dialog modal-md" role="document">
                          <div class="modal-content">
                            <?php $attributes = array('id' => 'validate');
                            echo form_open_multipart(base_url('e_nathi/note/'.$suggestion->id), $attributes);?>
                            
                            <div class="modal-body">
                              <textarea name="note" class="form-control input-sm required" rows="5"></textarea>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default" data-dismiss="modal">বন্ধ করুন</button>
                              <button type="submit" class="btn btn-primary">সংরক্ষণ এবং স্বাক্ষর </button>
                            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <ul class="nav nav-tabs" id="tab-01">
                ...
                <!-- <li><a href="#tab_attachment">নথি এটাচমেন্ট</a></li> -->
                <li><a href="#tab_note">নথির বিস্তারিত </a></li>
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab_letter">
                  ...
                  <?php foreach ($paragraph2 as $key => $para2) { ?>
                  <div class="priview-message">

                    <div class="row" >
                      <div class="col-sm-1 col-xs-1 text-right">
                        <?=$this->Common_model->en2bn($para2->paragraph_no)?>
                        
                      </div>
                      <div class="col-sm-11 col-xs-11">
                        <?=$para2->details?>
                        <?php if(!empty($para2->attachment)){ ?>
                          <table class="table table-bordered">
                              ...
                              <tbody>
                                <?php foreach ($para2->attachment as $file) { ?>
                                  <tr>
                                    <td><?=$file->name?></td>
                    ...
                    <div class="row" style="margin-bottom: 15px">
                      <?php foreach ($para2->note as $key => $info) {?>
                ...
                <?php } ?>
                  ...
                  <div class="row">
                        ...
                        <?php if($user->emp_designation == $suggestion->nathi_desk && ($suggestion->status == 1)):?>
                          <?php 
              $attributes = array('id' => 'validate');
              echo form_open_multipart(base_url('e_nathi/paragraph2'), $attributes);?>
                <div class="tab-content">
                  ...
                  <div role="" class="tab-pane active" id="">
                      <div class="">
                        ...
                        <input name="nathi_id" value="<?=set_value('nathi_id',$suggestion->nathi_id)?>" type="hidden" class="form-control input-sm datetime required" placeholder="DD-MM-YYYY" required>
                        <input name="page" value="<?=$suggestion->id?>" type="hidden" class="form-control input-sm datetime required" required>
                ...
                <?php echo form_close();?> 
                 ...
                 <div class="tab-pane" id="tab_attachment">
                  <img src="<?=base_url('efile_img/'.$suggestion->file_name)?>" class="img-responsive">
                </div>
