                     ...
                     <div class="col-md-12">
                        ...
                        <div class="row form-row">
                          ...
                          <div class="row form-row">
                           ...
                           <div class="col-md-3">
                              ...
                              <input type="radio" name="status" value="1" <?=isset($info) && isset($info->status) && set_value('status', $info->status)==1?'checked':'checked';?>> <span style="color: black; font-size: 14px;">Active</span>
                              <input type="radio" name="status" value="0" <?=isset($info) && isset($info->status) && set_value('status', $info->status)==0?'checked':'checked';?>> <span style="color: black; font-size: 14px;">Deactivate</span>
                       ...
                       <div class="row form-row">
                           ...
                           <div class="col-md-3">
                              ...
                              <?php if(isset($info) && isset($info->desk_officer)): ?>
                              ...
                              <input type="radio" name="desk_officer" value="0" <?=(set_value('desk_officer',$info->desk_officer)==0)?'checked':'checked';?>> <span style="color: black; font-size: 14px;">No</span>
                              <?php else: ?>
                              <input type="radio" name="desk_officer" value="1" <?=set_value('desk_officer')==1?'checked':'checked';?>> <span style="color: black; font-size: 14px;">Yes</span>
                              <input type="radio" name="desk_officer" value="0" <?=set_value('desk_officer')==0?'checked':'checked';?>> <span style="color: black; font-size: 14px;">No</span>
                              <?php endif; ?>
                           </div>
