            ...
            <div class="grid simple ">
               <div class="grid-title">
                  ...
                  <div class="pull-right">
                     ...
                     <a href="<?=base_url('award/community_development_award_approval_list_pdf/'.encrypt_url($info->id))?>" target="_blank" class="btn btn-blueviolet btn-xs btn-mini"> Generate Award Approve List PDF </a>
                  </div>            
               </div>
                           ...
                           <td align="right">
                              <div class="btn-group"> <a class="btn btn-primary dropdown-toggle btn-mini" data-toggle="dropdown" href="#"> Action <span class="caret"></span> </a>
                                 <ul class="dropdown-menu pull-right">
                                    <li><?=anchor("award/community_development_certificate_pdf/".encrypt_url($row->id), 'Generate Certificate PDF', array('target' => '_blank'))?></li>
                                 </ul>
                              </div>
                           </td>
                        </tr>
