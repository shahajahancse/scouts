                           ...
                           <td align="right">
                              <div class="btn-group"> <a class="btn btn-primary dropdown-toggle btn-mini" data-toggle="dropdown" href="#"> Action <span class="caret"></span> </a>
                                 <ul class="dropdown-menu pull-right">
                                    <li><?=anchor("award/community_development_recommendation_list/".encrypt_url($row->id), 'Community Development Recommendation List')?></li>
                                    <li><?=anchor("award/community_development_recommendation_form/".encrypt_url($row->id), 'Community Development Recommendation Form')?></li>
                                    <li><?=anchor("award/community_development_approve_list/".encrypt_url($row->id), 'Community Development Award Approve List')?></li>
                                 </ul>
                              </div>
                           </td>
                           <?php //} ?>
