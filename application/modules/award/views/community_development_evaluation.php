            ...
            <div class="grid simple ">
               <div class="grid-title">
                  ...
                  <div class="pull-right">
                     ...
                     <a href="<?=base_url('award/community_development_recommendation_list/'.encrypt_url($info->circular_id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Back to Recommended List</a>
                  </div>            
               </div>
                  ...
                  <table class="tg" width="100%">
                     ...
                     <tr>
                        ...
                        <td class="tg-ywa9">
                           ...
                           <a href="<?=base_url('award/community_development_approve_status/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-mini">Approve</a> 
                           <a href="<?=base_url('award/community_development_reject_status/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-mini">Reject</a>
                           <?php } ?>
                        </td>
