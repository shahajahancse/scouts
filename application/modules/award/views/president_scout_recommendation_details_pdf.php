     ...
     <div class="span12">
      ...
      <table class="table table-hover table-condensed" border="1">
        <caption class="title">২. দক্ষতা ব্যাজ ভিত্তিক যোগ্যতা অর্জনের বিবরণ (মাই গ্রোগেস এর তথ্য অনুযায়ী)</caption>
          ...
          <tr>
            <th> স্ট্যান্ডার্ড ব্যাজ </th> 
            <td></td>
            <td></td>
          </tr>
          <tr>
            <th> প্রোগ্রেস ব্যাজ </th> 
            <td></td>
            <td></td>
          </tr>
          <tr>
          ...
          <tr>
            <th> প্রেসিডেন্ট'স স্কাউট অ্যাওয়ার্ড </th> 
            <td></td>
            <td></td>
          </tr>        
      </table>  
      ...
      <table class="table table-hover table-condensed" border="1">
        ...
        <tr>
          ...
          <th colspan="2" align="center">পারদর্শিতা ব্যাজ</th>
        </tr>
        <tr>
        ...
        <tr>
          <th rowspan="4">স্ট্যান্ডার্ড ব্যাজ</th>
          <td width="180" align="center">চেতনা গ্রুপ</td>
          <td width="180">১)</td>
          <td width="180"></td>          
        </tr>
        <tr>
          <td align="right">.............................................. গ্রুপ</td>
          <td>২)</td>
          <td></td>
        </tr>
        <tr>
        ...
        <tr>
          <th rowspan="4">প্রোগ্রেস ব্যাজ</th>
          <td width="180" align="center">চেতনা গ্রুপ</td>
          <td width="180">১)</td>
          <td width="180"></td>          
        </tr>
        ...
        <tr>
          <th rowspan="4">প্রেসিডেন্ট'স স্কাউট অ্যাওয়ার্ড</th>
          <td width="180" align="center">চেতনা গ্রুপ</td>
          <td width="180">১)</td>
          <td width="180"></td>          
        </tr>
      ...
      <table class="noBorder" border="0">        
        <tr>
          <td colspan="2"><strong>৪.</strong> আমি <strong> <?=$info->full_name_bn?> </strong> আমার আত্মমর্যাদার উপর নির্ভর করে ঘোষনা করছি যে, উপরে বর্ণিত বিবরণসমূহ সম্পূর্ণ নির্ভূল। আমি প্রসিডেন্ট'স স্কাউট অ্যাওয়ার্ড অর্জনের জন্য স্কাউট প্রোগ্রাম অনুযায়ী সকল বিষয়ে দক্ষতা ও পারদর্শিতা অর্জন করেছি এবং অ্যাওয়ার্ড অর্জনের লক্ষ্যে যথানিয়মে মূল্যায়নে অংশগ্রহণ করে সাফল্য অর্জন করেছি।</td>
        </tr>
        <tr>          
          <td></td>
          <td align="right" width="300">
            <hr>
            <strong>প্রসিডেন্ট'স স্কাউট অ্যাওয়ার্ড প্রার্থী</strong><br>
            তারিখ ...... ...................
          </td>          
        </tr>
      </table>
      ...
      <table class="noBorder" border="0">        
        <tr>
          <td colspan="3">
            <strong>৫.</strong> স্কাউট <strong> <?=$info->full_name_bn?> </strong> প্রেসিডেন্ট'স স্কাউট অ্যাওয়ার্ড অর্জনের জন্য মূল্যায়নে কৃতকার্য হয়েছে। তাকে প্রেসিডেন্ট'স স্কাউট অ্যাওয়ার্ড প্রদানের সুপারিশ করা হলো।
          </td>
        </tr>
        <tr>          
      ...
      <table class="table table-hover table-condensed" border="0">
        ...
        <table class="table table-hover table-condensed" border="0">
          <caption class="title">(গ)উপজেলা স্কাউট লিডারের মতামতঃ </caption>
          <tr>
            <td height="100"></td>
            <td rowspan="2" width="150"></td>
            <td rowspan="2">স্বাক্ষর ও সীল</td>
          </tr>
          <tr>
            <td>উপজেলা স্কাউট লিডার নিয়োগ সনদ নং    ও তারিখ.................................</td>
          </tr>
        </table>
      ...
      <table class="noBorder" border="0">        
        <tr>
          <td colspan="3">
          <strong>৭.</strong> এই মর্মে প্রত্যয়ন করা যাচ্ছে য স্কাউট <strong> <?=$info->full_name_bn?> </strong> প্রেসিডেন্ট'স স্কাউট অ্যাওয়ার্ড অর্জনের জন্য প্রয়োজনীয় যোগ্যতা অর্জন করেছে।
তাকে প্রেসিডেন্ট'স স্কাউট অ্যাওয়ার্ড প্রদানের সুপারিশ করা হলো।
          </td>
        </tr>
        <tr>          
      ...
      <table class="table table-hover table-condensed" border="0">
        ...
        <table class="table table-hover table-condensed" border="0">
          ...
          <tr>
            <td>জেলা স্কাউট লিডার নিয়োগ সনদ নং    ও তারিখ.................................</td>
          </tr>
        </table>
        <br>
      ...
      <table class="noBorder" border="0">        
        <tr>
          <td colspan="3">
          <strong>১০.</strong> এই মর্মে প্রত্যয়ন করা যাচ্ছে যে স্কাউট <strong> <?=$info->full_name_bn?> </strong> প্রেসিডেন্ট'স স্কাউট অ্যাওয়ার্ড অর্জনের প্রয়োজনীয় যোগ্যতা অর্জন করেছে। তাকে প্রেসিডেন্ট'স স্কাউট অ্যাওয়ার্ড প্রদানের জন্য সুপারিশ করা হলো।
          </td>
        </tr>
        <tr>          
          <td align="left" width="35%" height="150">
      ...
      <table class="table table-hover table-condensed" border="0">
        ...
        <table class="table table-hover table-condensed" border="0">
          <caption class="title">(গ) আঞ্চলিক উপ কমিশনার (প্রোগ্রাম) এর মতামতঃ </caption>
          <tr>
            <td height="100"></td>
            <td rowspan="2" width="150"></td>
            <td rowspan="2">স্বাক্ষর ও সীল</td>
          ...
          <tr>
            <td>আঞ্চলিক উপ কমিশনার (প্রোগ্রাম) নিয়োগ সনদ নং    ও তারিখ.................................</td>
          </tr>
        </table>   
      ...
      <table class="noBorder" border="0">   
        <tr>
          <td align="left">
            <hr width="200px;">
            <strong>আঞ্চলিক উপ কমিশনার </strong><br>
            <?=$info->region_name?> <br>
            তারিখ .........................
          </td>
          <td align="right">
        ...
        <tr>
          <td><strong>১৩.</strong> স্নারক নং  <strong> </td>
          <td>তারিখ ......................... </td>
        </tr>
        <tr>
      ...
      <table class="table table-hover table-condensed" border="1">
        <caption class="title">১৪. জাতীয় সদর দফতর কর্তৃক মূল্যায়নঃ</caption>
          <tr>
            <th style="width:120" align="center" colspan="2"> লিখিত মূল্যায়ন </th> 
            <th align="center">ব্যাবহারিক</th>
            <th align="center">ব্যক্তিগত সাক্ষাতকার</th>
            <th align="center">মোট নম্বর </th>
            <th align="center">ফলাফল</th>
            <th align="center">মন্তব্য</th>
          </tr>
          <tr>
            <td align="center">প্রথম পত্র</td> 
            <td align="center">দ্বিতীয় পত্র</td>
            <td rowspan="2"></td>
            <td rowspan="2"></td>
            <td rowspan="2"></td>
            <td rowspan="2"></td>
