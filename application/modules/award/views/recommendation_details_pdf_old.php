              ...
              <div class="row" style="margin-top: 20px;">
               <div class="col-md-12">
                <p>স্কাউট আন্দোলনের সার্বিক উন্নয়ন , সম্প্রসারণ, প্রশিরক হিসেবে দায়িত্ব পালন, গ্রুপ/ইউনিক পরিচালনার সাইটেশন(সংক্ষিপ্ত বিবরণ) ।<br>
                  ...
                  <table>
                    <caption style="text-align: left;">সাইটেশনঃ</caption>
                    <tr>
                      <th>অফিস পর্যায়</th>
                      <th>ইভেন্টের ধরণ</th>
                      <th>তারিখ হতে</th>
                    ...
                    <tr> 
                      <td>জাতীয় সদর দপ্তর</td>
                      <td><?php echo $info->ec_name_nhq;?></td>
                      <td><?php echo date_browse_format($info->date_from_nhq);?></td> 
                      <td><?php echo date_browse_format($info->date_to_nhq);?></td> 
                      <td><?php echo $info->activity_nhq;?></td> 
                    </tr>
                    <tr> 
                      <td>অঞ্চল</td>
                      <td><?php echo $info->ec_name_region;?></td>
                      <td><?php echo date_browse_format($info->date_from_region);?></td> 
                      <td><?php echo date_browse_format($info->date_to_region);?></td> 
                      <td><?php echo $info->activity_region;?></td> 
                    </tr>
                    <tr> 
                      <td>জেল</td>
                      <td><?php echo $info->ec_name_district;?></td>
                      <td><?php echo date_browse_format($info->date_from_district);?></td> 
                      <td><?php echo date_browse_format($info->date_to_district);?></td> 
                      <td><?php echo $info->activity_district;?></td> 
                    </tr>
                    <tr> 
                      <td>উপজেল</td>
                      <td><?php echo $info->ec_name_upazila;?></td>
                      <td><?php echo date_browse_format($info->date_from_upazila);?></td> 
                      <td><?php echo date_browse_format($info->date_to_upazila);?></td> 
                      <td><?php echo $info->activity_upazila;?></td> 
                    </tr>
                  </table>
                  <br><br>

                  <b>জাতীয় সদর দপ্তর সাইটেশনঃ</b><br>
                  <?php echo $info->citation_nhq; ?> <br><br>               

                  <b>অঞ্চলের সাইটেশনঃ</b><br>
                  <?php echo $info->citation_region; ?><br><br>

                  <b>জেলার সাইটেশনঃ</b><br>
                  <?php echo $info->citation_district; ?><br><br>

                  <b>উপজেলার সাইটেশনঃ</b><br>
                  <?php echo $info->citation_upazila; ?><br><br>
