                           ...
                           <td align="right">
                              <div class="btn-group"> <a class="btn btn-primary dropdown-toggle btn-mini" data-toggle="dropdown" href="#"> Action <span class="caret"></span> </a>
                                 <ul class="dropdown-menu pull-right">
                                    <li><?=anchor("award/president_rover_scout_recommendation_list/".encrypt_url($row->id), 'President Rover Scout Recommendation List')?></li>
                                    <li><?=anchor("award/president_rover_scout_recommendation_form/".encrypt_url($row->id), 'President Rover Scout Recommendation Form')?></li>
                                    <li><?=anchor("award/president_rover_scout_approve_list/".encrypt_url($row->id), 'President Rover Scout Award Approve List')?></li>
                                 </ul>
                              </div>
                           </td>
                           <?php //} ?>
