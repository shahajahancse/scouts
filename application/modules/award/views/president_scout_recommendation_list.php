            ...
            <div class="grid simple ">
               <div class="grid-title">
                  ...
                  <div class="pull-right">
                     ...
                     <a href="<?=base_url('award/president_scout_award_approval_list_pdf/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Generate Award Approve PDF List</a>
                  </div>            
               </div>
                           ...
                           <td align="right">
                              <div class="btn-group"> <a class="btn btn-primary dropdown-toggle btn-mini" data-toggle="dropdown" href="#"> Action <span class="caret"></span> </a>
                                 <ul class="dropdown-menu pull-right">
                                    <li><?=anchor("award/president_scout_recommendation_details_pdf/".encrypt_url($row->id), 'Details PDF', array('target' => '_blank'))?></li>
                                    <li><a href="<?=base_url('award/president_scout_evaluation/'.encrypt_url($row->id))?>">Award Evaluation</a></li>
                                    <!-- <li><a href="#">Update</a></li> -->
                                    <?php if($this->ion_auth->is_admin() || $this->ion_auth->is_scout_admin()){ ?>
                                    <li><?=anchor("award/president_scout_recommendation_delete/".encrypt_url($row->id)."/".encrypt_url($row->circular_id), 'Delete', 'onclick="return confirm(\'Be careful! Are you sure you want to delete this data?\');"')?></li>
                                    <?php } ?>
                                 </ul>
                              </div>
                           </td>
