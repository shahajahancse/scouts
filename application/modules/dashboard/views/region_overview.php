          ...
          <div class="tiles-body">
            ...
            <div class="widget-stats">
              <div class="wrapper transparent"> 
                <span class="item-title">Total Registration</span> <span class="item-count animate-number" style="font-size: 25px;" data-value="<?=$total_online->count?>" data-animation-duration="700">0</span>
              </div>
            </div>
            <div class="widget-stats">
              <div class="wrapper transparent"> 
            ...
            <div class="widget-stats ">
              <div class="wrapper last"> 
                <span class="item-title">Total Pending</span> <span class="item-count animate-number" style="font-size: 25px;" data-value="<?=$total_online->request?>" data-animation-duration="700">0</span> 
              </div>
            </div>
            <!-- <div class="widget-stats ">
              <div class="wrapper last"> 
