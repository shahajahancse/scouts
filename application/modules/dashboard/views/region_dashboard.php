	...
	<div class="content">
		...
		<div class="row">  
			<div class="col-md-12">
				...
				<h2 class="pull-left">Welcome, <strong><?=$info->region_name_en?></strong>  <?=$img?></h2> 
					...
					<div class="col-md-4">
						...
						<table class="tg2">
            				...
            				<th class="tg-wxkd" style="text-align: right;">Member</th>
								...
								<?php //$gTSCgroup += $tSCgroup; ?>
								<?php //$gTmember += $tMember; ?>
								<?php } ?>
								
								<?php /*
								<tr>
									<td class="tg-idlo"></td>
									<td class="tg-m7qj" style="text-align: right;"><?=$gTSCgroup?></td>
              					<td class="tg-m7qj" style="text-align: right;"><?=$gTmember?></td>
								</tr>
								*/ ?>
							...
							<table class="tg">
								...
								<tr>
									...
									<th class="tg-rmb8" style="text-align: center;font-weight: bold; font-style: italic;">
										<?php echo $c = $A + $B + $na_male_total; ?></th>
									<th class="tg-rmb8"  style="text-align: center;font-weight: bold; font-style: italic;">
										<?php echo $c_f = $A_f + $B_f + $na_female_total;?></th>
