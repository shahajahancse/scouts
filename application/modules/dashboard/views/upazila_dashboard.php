	...
	<div class="content">
		...
		<div class="row">  
			<div class="col-md-12">
				...
				<h2>Welcome, <strong><?=$info->upa_name?></strong></h2> <br><br>
					...
					<div class="col-md-6 col-vlg-3 col-sm-6">
						<div class="tiles green added-margin  m-b-20">
							<div class="tiles-body">
								<div class="tiles-title text_white_14">Upazila Registration Overview</div>
								<?php /*
					...
					<div class="col-md-6 col-vlg-3 col-sm-6">
						<div class="tiles red added-margin  m-b-20">
							<div class="tiles-body">
								...
								<div class="tiles-title text_white_14"><?=$info->upa_name?></div>
								<div class="widget-stats">
									<div class="wrapper last">
				...
				<div class="row">					
					<div class="col-md-12">
						<?php $exp_office = explode(',', $info->upa_name);?>
					...
					<div class="col-md-12">
						<style type="text/css">
							...
							.tg2 .tg-wxkd{background-color:#9698ed;color:#000;border-color:#6665cd;}
							.tg2 .tg-idlo{font-weight:bold;font-size:14px;background-color:#cbcefb;color:#000;border-color:#9698ed;text-align:right}
							.tg2 .tg-m7qj{font-weight:bold;font-size:14px;background-color:#cbcefb;color:#000;border-color:#9698ed;text-align:left}
						</style>
						
						<?php /* *** */ ?>
						<h3 style="text-align: center; font-weight: bold; "> Scout Group Statistics</h3>
						<table class="tg2 table-hover">
							<tr>
								<th class="tg-wxkd">SL</th>
								<th class="tg-wxkd">Group Name</th>
								<th class="tg-wxkd">Member</th>
							</tr>
							<?php 
							$sl=0;
							$tMember = 0;
							...
							foreach ($officelist as $row) { 
								...
								$tMember = $this->Dashboard_model->get_count_scouts_member_by_office_id('', '', '', $row->id); 
								//$gTMember += $tMember['count'];
							?>
							<tr>
								<td class="tg-idlo" style="text-align: left; width: 40px;"><?=$sl?>.</td>
								<td class="tg-idlo" style="text-align: left;"><?=$row->grp_name?></td>
								<td class="tg-m7qj" style="padding-left: 20px; text-align: right;"><?=$tMember['count']?></td>
							</tr>
							<?php } ?>							
						</table>
						<?php /* *** */ ?>
				...
				<div class="alert alert-block alert-error fade in">
					...
					<p> <h4>Currently you have no scout upazila access.</h4> </p>
