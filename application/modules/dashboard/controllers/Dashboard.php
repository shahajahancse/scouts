...
class Dashboard extends Backend_Controller {
	...
	// 	$this->data['office_list'] = $this->Dashboard_model->get_scouts_gorup($upazilaID);
	// 	//echo '<pre>';
	// 			//print_r($this->data['office_list']); exit;
	// 	// echo count($this->data['office_list']); exit;
	// 	echo '<table border="1">';

	// 	 	foreach ($this->data['office_list'] as $value) {
	 //         	$data_arr[$value->id]['total_group_member'] = $this->Dashboard_model->get_count_scouts_member_by_office_id('', '', '', $value->id);
	 //         	echo '<tr> <td>'.$value->grp_name.'</td><td>'.$data_arr[$value->id]['total_group_member']['count'].'</td></tr>';
	 //         }

	// 	// foreach ($this->data['office_list'] as $value) {
	// 	// 	echo '<tr> <td>'.$value->grp_name.'</td></tr>';
	// 	// 	# code...
	// 	// }
	// 	echo '</table>';
	// }
