            ...
            <table class="table table-hover table-condensed">
              <thead>
                <tr>
                  ...
                  <th style="width:15%">Group Verify</th>
                  <th style="width:15%">District Verify</th>                  
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="v-align-middle"><?=migrate_verify_status($row->mig_district_verify)?></td>
                    <td class="text-center">
                      <a href="<?=base_url('migration/details/'.$row->id);?>" class="btn btn-primary btn-xs btn-mini">Details</a>     
