              ...
              <div class="col-md-6">
                ...
                <table class="tg">
                  ...
                  <table class="tg">
                    ...
                    <?php } ?>
                    <tr>
                      <th class="tg-9vst">District Verify Status:</th>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mig_admn_cmnt" id="mig_admn_cmnt">
                        <input type="hidden" name="migration_id" id="migration_id" value="<?= $info->migration_id ?>">
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  function current_group_verify(action)
  {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url('migration/current_group_verify'); ?>",
      data: 
      {
        id : $('#migration_id').val(),
        cmnt : cmnt,
