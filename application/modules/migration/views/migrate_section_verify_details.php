                ...
                <table class="tg">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="row">
                        <div class="col-md-2">
                          <button class="btn btn-success" onclick="migration_section_verify('Approved')">Accept</button>
                        </div>
                        <div class="col-md-2">
                          <button class="btn btn-danger" onclick="migration_section_verify('Reject')">Deny</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  function migration_section_verify(action)
  {
