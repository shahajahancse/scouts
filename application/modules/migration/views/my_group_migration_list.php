      ...
      <div class="span12">
        <div class="grid simple ">
          ...
          <div class="grid-body ">
            ...
            <?php endif; ?>
            <!-- <a href="<?=base_url('Migration/my_group_migration_list_pdf')?>" class="btn btn-primary btn-xs btn-mini" style="float: right;">PDF Download</a> -->
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="<?=base_url('migration/release_group_verify/'.$row->id);?>" class="btn btn-primary btn-xs btn-mini">Details</a>     
