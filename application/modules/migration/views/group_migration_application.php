<div class="page-content">
  <div class="content">
    <ul class="breadcrumb" style="margin-bottom: 20px;">
      ...
      <li> <a href="<?=base_url('migration/my_group_migration_list')?>" class="active"> <?=$module_title; ?> </a></li>
      <li><?=$meta_title; ?></li>
    </ul>
    <style type="text/css">
      ...
      <div class="col-md-12">
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            <?php endif; ?>
            <?php
              $attributes = array('id' => 'group_migration_validation');
              echo form_open("migration/group_migration_application", $attributes);

              if($info->region_type == 'divisional'){
                $upazila = $info->upa_name;
              }else{
                $upazila = 'N/A';
              } ?>
              ...
              <div class="row">
                <div class="col-md-5">
                  <!-- <a href="<?=base_url('Migration/group_migration_application_pdf')?>" class="btn btn-primary btn-xs btn-mini" style="float: right;">PDF Download</a> -->
                ...
                <div class="col-md-7">
                  <?php
                    ...
                    if(!$info->sc_group_id){
                      ...
                      <div class="alert alert-block alert-warning fade in">
                        ...
                        <p>Scout Region, District, Upazila, and Group are required to apply for group migration.</p>
                      </div>
                      <?php
                    }
                  ?>
                  ...
                  <div class="alert alert-block alert-warning fade in">
                    <ol>
                      <strong>Group Migration Process:</strong>
                      <li>Fill up all information for group migration</li>
                      <li>You can view your migration application form "My Group Migration List"</li>
                      <li>Now your application is verifying for group release from your current group admin</li>
                      <li>After your current group admin release then sent notification to migrate group admin</li>
                      <li>Finally migrate group admin is accepting this application and this scout member transfers to migrate group</li>
                    </ol>
                  </div>

                  <h4 style="font-weight: bold;">Migration To Group</h4>
                  ...
                  <div class="row form-row">
                    <div class="col-md-6">
                      ...
                      <!-- <select name="mig_upazila_id" class="sc_upazila_thana_val basic-select2 form-control input-sm"  id="sc_upazila_thana">
                        <option value="">-- Select One --</option>
                      </select> -->

                      <?php
                        echo form_error('mig_upazila_id');
                        $more_attr = 'class="sc_upazila_thana_val form-control input-sm basic-select2"  id="sc_upazila_thana"';
                        echo form_dropdown('mig_upazila_id', $scout_upazila_thana, set_value('mig_upazila_id', ''), $more_attr);
                      ?>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <!-- <select name="mig_group_id" class="sc_group_val scoutsGroupSelect2 form-control input-sm" id="sc_unit">
                        <option value="">-- Select One --</option>
                      </select> -->

                      <?php
                        echo form_error('mig_group_id');
                        $more_attr = 'class="sc_group_val form-control input-sm scoutsGroupSelect2" id="sc_unit"';
                        echo form_dropdown('mig_group_id', array('0' => 'Search Scout Group'), set_value('mig_group_id',''), $more_attr);
                      ?>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#group_migration_validation').validate({
      // focusInvalid: false,
      ignore: "",
      rules: {
        mig_reasons: {
