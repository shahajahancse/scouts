            ...
            <div class="row">
                ...
                <div class="scout-verify-box">
                  ...
                  <table class="tg">
                    ...
                    <tr>
                      ...
                      <td class="tg-031e"><?php echo $info->current_member_type;?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="tg-031e"><?=$info->current_role_name?></td>
                    </tr>
                    <tr>
              ...
              <div class="col-md-6">
                ...
                <table class="tg">
                    ...
                    <tr>
                      <th class="tg-9vst">Member Type:</th>
                      <td class="tg-031e"><?php echo $info->member_type;?></td>
                    </tr>
                    <tr>
                      <th class="tg-9vst">Section:</th>
                      <td class="tg-031e"><?= get_scout_section($info->mig_section_id) ?></td>
                    </tr>
                    <tr>
                      <th class="tg-9vst">Scout Badge:</th>
                      <td class="tg-031e"><?= $info->mig_badge_name ?></td>
                    </tr>
                    <tr>
                      <th class="tg-9vst">Scout Role:</th>
                      <td class="tg-031e"><?= $info->mig_role_name ?></td>
                    </tr>
                  </table>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Release Group Admin Comment</label>
                        <input type="text" class="form-control" name="grp_admn_cmnt" id="grp_admn_cmnt">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="row">
                        <div class="col-md-2">
                          <button class="btn btn-success" onclick="current_group_verify('Approved')">Accept</button>
                        </div>
                        <div class="col-md-2">
                          <button class="btn btn-danger" onclick="current_group_verify('Reject')">Deny</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  function current_group_verify(action)
  {
    var cmnt = $('#grp_admn_cmnt').val();

    $.ajax({
      type: "POST",
      url: "<?php echo base_url('migration/migration_section_verify'); ?>",
      data: 
      {
        id : $('#migration_id').val(),
        cmnt : cmnt,
