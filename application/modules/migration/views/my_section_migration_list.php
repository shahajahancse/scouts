      ...
      <div class="span12">
        <div class="grid simple ">
          ...
          <div class="grid-body ">
            ...
            <?php endif; ?>
            <!-- <a href="<?=base_url('Migration/my_section_migration_list_pdf')?>" class="btn btn-primary btn-xs btn-mini" style="float: right;">PDF Download</a> -->
            <table class="table table-hover table-condensed">
              <thead>
                <tr>
                  <th width="20"> SL </th>
                  <th width="100">Scout ID</th>
                  <th>Name</th>
                  <th>Migration Reason</th>                  
                  <th width="130">App. Date</th>
                  <th width="200">Migration Group Verify</th>                  
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="v-align-middle"><?=$row->mig_reasons?></td>
