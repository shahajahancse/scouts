            ...
            <div class="grid simple">
               ...
               <div class="grid-body">
                  ...
                  <div class="pdf-download">
                     <a href="<?=base_url('Committee/region_pdf')?>" class="btn btn-primary btn-xs btn-mini">PDF Download</a>
                  </div>
                  ...
                  <div class="pagination-wrapper">
                     <div class="total-count">
                        Total <span style="color: green; font-weight: bold;"><?php echo $total_rows; ?> Region Committee </span>
                     </div>
