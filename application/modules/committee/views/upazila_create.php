         ...
         <div class="col-md-12">
            <div class="grid simple horizontal red">
               ...
               <div class="grid-body">
                  ...
                  echo form_open_multipart("committee/upazila_create",$attributes);
                  ?>
                  <div class="row form-row">
                     <div class="col-md-12">
                        <label class="form-label">Upazila Committee Name and Session</label>
                        <?php echo form_error('committee_name');?>
                        <input name="committee_name" id="committee_name" value="<?=set_value('committee_name')?>" type="text" class="form-control input-sm" placeholder="Scouts Upazila (Executive or Program or etc.) Committee Name (2019-2021)">
                     </div>
                  </div>
