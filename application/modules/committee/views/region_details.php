            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                    <a href="<?=base_url('committee/region')?>" class="btn btn-blueviolet btn-xs btn-mini"> Committee List</a>  &nbsp;
                    <?php if($this->ion_auth->is_region_admin()){ ?>
                    <a href="<?=base_url('committee/region_update/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Committee Update</a> &nbsp;
                    <a href="<?=base_url('committee/region_manage_member/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Manage Member</a> &nbsp;
                    <?php } ?>
                    <a href="<?=base_url('committee/pdf_region_committee/'.encrypt_url($info->id))?>" class="btn btn-success btn-mini" target="_blank"> Download PDF</a>
                 </div>
              </div>
