            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     ...
                     <a href="<?=base_url('committee/national_details/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini">Committee Details</a>    
                  </div>
               </div>
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     <div class="col-md-12">
                        ...
                        <input name="committee_name" id="committee_name" value="<?=set_value('committee_name', $info->committee_name)?>" type="text" class="form-control input-sm" placeholder="National (Executive or Program or etc.) Committee Name (2019-2021)">
                     </div>
                  </div>
