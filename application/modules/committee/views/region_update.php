         ...
         <div class="col-md-12">
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <a href="<?=base_url('committee/region')?>" class="btn btn-blueviolet btn-xs btn-mini"> Region Committee List</a>  
                     <a href="<?=base_url('committee/region_details/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini">Committee Details</a>    
                  </div>
               </div>
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     <div class="col-md-12">
                        <label class="form-label">Region Committee Name</label>
                        <?php echo form_error('committee_name');?>
                        <input name="committee_name" id="committee_name" value="<?=set_value('committee_name', $info->committee_name)?>" type="text" class="form-control input-sm" placeholder="Scouts Region (Executive or Program or etc.) Committee Name (2019-2021)">
                     </div>
                  </div>
