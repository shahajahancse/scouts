<div class="page-content">     
   <div class="content">  
      <ul class="breadcrumb">
         ...
         <li> <a href="<?=base_url('committee/district')?>" class="active"><?=$module_name?> </a> </li>
         <li><?=$meta_title; ?></li>
      </ul>
         ...
         <div class="col-md-12">
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <a href="<?=base_url('committee/district')?>" class="btn btn-blueviolet btn-xs btn-mini"> District Committee List</a>  
                     <a href="<?=base_url('committee/district_details/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini">Committee Details</a>    
                  </div>
               </div>
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     <div class="col-md-12">
                        <label class="form-label">District Committee Name</label>
                        <?php echo form_error('committee_name');?>
                        <input name="committee_name" id="committee_name" value="<?=set_value('committee_name', $info->committee_name)?>" type="text" class="form-control input-sm" placeholder="Scouts District (Executive or Program or etc.) Committee Name (2019-2021)">
                     </div>
                  </div>
