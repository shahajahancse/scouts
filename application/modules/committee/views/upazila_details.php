            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                    <a href="<?=base_url('committee/upazila')?>" class="btn btn-blueviolet btn-xs btn-mini"> Committee List</a>  &nbsp;
                    <?php if($this->ion_auth->is_upazila_admin()){ ?>
                    <a href="<?=base_url('committee/upazila_update/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Committee Update</a> &nbsp;
                    <a href="<?=base_url('committee/upazila_manage_member/'.encrypt_url($info->id))?>" class="btn btn-blueviolet btn-xs btn-mini"> Manage Member</a> &nbsp;
                    <?php } ?>
                    <a href="<?=base_url('committee/pdf_upazila_committee/'.encrypt_url($info->id))?>" class="btn btn-success btn-mini" target="_blank"> Download PDF</a>
                 </div>
              </div>
