              ...
              <div class="col-md-12">              
                <div class="row form-row">
                  <div class="col-md-3">
                    ...
                    echo form_dropdown('progress_type', $progress, set_value('progress_type', $info->progress_type), $more_attr);
                    ?>
                 </div>
                  <div class="col-md-3">
                    ...
                    echo form_dropdown('section_id', $section, set_value('section_id', $info->progress_type), $more_attr);
                    ?>
                 </div>
                 <div class="col-md-4">
                    <label class="form-label">Course Name <span class="required">*</span></label>
                    <?php echo form_error('course_id');
                    $more_attr = 'class="prog_course_val form-control input-sm" id="otherCourse"';
                    echo form_dropdown('course_id', $courses, set_value('course_id', $info->course_id), $more_attr);
                    ?>
                 </div>
                 <div class="col-md-2">
                    <label class="form-label">Course Number </label>
                    <?php echo form_error('course_number');?>
                    <input type="text" name="course_number" class="form-control input-sm" value="<?=set_value('course_number', $info->course_number)?>" placeholder="">
                 </div>
                 <div class="col-md-12" id='others_course'>
                    <label class="form-label">Other Course</label>
                    <?php echo form_error('other_course_name'); ?>
                    <input name="other_course_name" value="<?=set_value('other_course_name', $info->other_course_name)?>" type="text" class="form-control input-sm" placeholder="">
                 </div>
                </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="row form-row">
                     <div class="col-md-7">
                        ...
                        <input name="training_title" value="<?=set_value('training_title', $info->training_title)?>"  type="text"  class="form-control input-sm">
                     </div>
                     <div class="col-md-5">
                        <label class="form-label">Place <span class="required">*</span></label>
                        <?php echo form_error('place'); ?>
                        <input name="place" value="<?=set_value('place', $info->place)?>" type="text" class="form-control input-sm">
                     </div>
                  </div>
               </div>
                ...
                <div class="row form-row">
                  <div class="col-md-12">
                    ...
                    <div class="row form-row">
                      ...
                      <div class="col-md-4">
                        <h5 class="semi-bold"><input type="checkbox" name="tt_international" value="1" <?=set_value('tt_international',$info->tt_international)=='1'?'checked':'';?>> International</h5>
                      </div>
                    </div>
                    <?php } ?>
              ...
              <div class="col-md-7">
                <div class="row form-row">
                  <div class="col-md-12">
                    ...
                    <textarea name="details" rows="8" style="width: 100%" id=""><?=$info->details?></textarea>
                  </div>
                </div>
              </div> <!-- /col-md-7 -->
              ...
              <div class="col-md-5">
                ...
                <div class="row form-row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="start_date" value="<?=set_value('start_date', date_bangla_format($info->start_date))?>" class="form-control input-sm datetime" id="" placeholder="DD-MM-YYYY">
                  </div>
                  <div class="col-md-6">
                    <label class="form-label">Training Date of Closing <span class="required">*</span></label>
                    <input type="text" name="end_date" value="<?=set_value('end_date', date_bangla_format($info->end_date))?>" class="form-control input-sm datetime" id="" placeholder="DD-MM-YYYY">
                  </div>
                </div>
                ...
                <div class="row form-row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="reg_start" value="<?=set_value('reg_start', date_bangla_format($info->reg_start))?>" class="form-control input-sm datetime" placeholder="DD-MM-YYYY">
                  </div>

                  <div class="col-md-6">
                    <label class="form-label">Registration Last Date <span class="required">*</span></label>
                    <input type="text" name="reg_end" value="<?=set_value('reg_end', date_bangla_format($info->reg_end))?>" class="form-control input-sm datetime" placeholder="DD-MM-YYYY">
                  </div>
                </div>
                    ...
                    <?php
                      if($attachments){
                        ...
                        foreach ($attachments as $value) {
                          ...
                          echo '<a href="'.base_url('training_docs/'.$value->file_name).'" download="'.$value->file_name.'" class="btn btn-mini btn-xs btn-success" style="margin-bottom:2px;">Download - '.$value->file_name.'</a>';
                          echo '<a href="'.base_url('training/attachment_del/'.$value->id.'/'.$info->id).'" onclick="return confirm(\'Are you sure you want to delete this file?\');" class="btn btn-mini btn-xs btn-denger"><i class="fa fa-times-circle"></i></a>';
                          echo '<br>';
                        }
                      }
                    ?>
