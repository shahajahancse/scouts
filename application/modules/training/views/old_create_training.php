             ...
             <div class="grid-title">
              <h4><span class="semi-bold"><?=$meta_title; ?></span></h4>
                ...
                <div class="pull-right">
                  ...
                  <a href="<?=base_url('training/upcomming_training_list')?>" class="btn btn-blueviolet btn-xs btn-mini"> Upcomming Training List</a> 
                </div> 
             </div>
             <div class="grid-body">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row form-row">
                    <div class="col-md-10">
                      ...
                      <?php 
                        ...
                        echo form_dropdown('training_name', $training, set_value('training_name'),$css ); 
                      ?>
                      
                    </div>
                    <div class="col-md-10">
                      <label class="form-label">Training Center<span class="required">*</span></label>
                      <?php echo form_error('training_center'); ?>
                      <input name="training_center" id="training_center" type="text"  class="form-control input-sm" value="<?=set_value('training_center')?>">
                    </div>
                    <div class="col-md-10">
                      ...
                      <?php 
                        ...
                        echo form_dropdown('trainer_id', $teacher, set_value('trainer_id'),$css ); 
                      ?>
                    </div>
                  </div>
                  ...
                  <div class="row form-row">
                    <div class="col-md-10">
                      ...
                      <textarea name="training_details" rows="7" cols="72"><?=set_value('training_details')?></textarea>
                    </div>                    
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="row form-row">
                    <div class="col-md-6">
                      ...
                      <input name="training_start_date" id="datetime" type="text" class="form-control input-sm datetime" value="<?=set_value('training_start_date')?>">
                    </div>
                    <div class="col-md-6">
                      <label class="form-label">To Date<span class="required">*</span></label>
                      <?php echo form_error('training_end_date'); ?>
                      <input name="training_end_date" id="datetime" type="text" class="form-control input-sm datetime" value="<?=set_value('training_end_date')?>">
                    </div>
                    <div class="col-md-6">
                      <label class="form-label">Duration<span class="required">*</span></label>
                      <?php echo form_error('training_duration'); ?>
                      <input name="training_duration" id="" type="text" class="form-control input-sm " value="<?=set_value('training_duration')?>">
                    </div>
                    <div class="col-md-6">
                      <label class="form-label">Minimum Attendance<span class="required">*</span></label>
                      <?php echo form_error('min_attendance'); ?>
                      <input name="min_attendance" id="" type="text" class="form-control input-sm " value="<?=set_value('min_attendance')?>">
                    </div>
                  </div>
                  ...
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <input type="radio" name="training_type" value="National" <?=$this->input->post('training_type')=='National'?'checked':'';?>> National
                      <input type="radio" name="training_type" value="International" <?=$this->input->post('training_type')=='International'?'checked':'';?>> International
                    </div>
                  </div>
