       ...
       <div class="col-md-8">
          <div class="grid simple horizontal red">
             ...
             <div class="grid-body">
              ...
              echo form_open_multipart("general_setting/progress_course_add");?>

              <div class="row form-row">
                <div class="col-md-6">
                  <label class="form-label">Member Type</label>
                  <?php echo form_error('progress_id'); ?>
                  <?php echo form_dropdown('progress_id',$progress, set_value('progress_id'), ' class="form-control input-sm"');?>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <input name="course_name" id="course_name" type="text" value="<?=set_value('course_name')?>" class="form-control input-sm" placeholder="">
                </div>
              </div>
