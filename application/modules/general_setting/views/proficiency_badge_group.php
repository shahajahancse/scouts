                ...
                ?>
                  <tr>
                    ...
                    <td class="btn-group-responsive">
                      <?php echo anchor(base_url()."general_setting/proficiency_badge_group_edit/".$row->id, 'Edit', 'class="btn btn-mini btn-primary"') ;?>
                      <a class="btn btn-mini btn-primary" href="<?=base_url()?>general_setting/proficiency_badge_group_delete/<?=$row->id?>" onclick="return confirm('Are you sure you want to delete this Proficiency Badge Group?');">Delete</a>
                    </td>
                  </tr>
                  <?php endforeach;?>                      
                </tbody>
