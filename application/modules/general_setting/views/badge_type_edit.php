       ...
       <div class="col-md-8">
          <div class="grid simple horizontal red">
             ...
             <div class="grid-body">
              ...
              echo form_open_multipart("general_setting/badge_type_edit/".$info->id, $attributes);?>

              <div class="row form-row">
                <div class="col-md-6">
                  <label class="form-label">Badge Type Name BN</label>
                  <?php echo form_error('badge_type_name_bn'); ?>
                  <?php echo form_input('badge_type_name_bn', set_value('badge_type_name_bn', $info->badge_type_name_bn), 'id="badge_type_name_bn" class="form-control input-sm"');?>
                </div>
              	<div class="col-md-6">
                  <label class="form-label">Badge Type Name EN</label>
                  <?php echo form_error('badge_type_name_en'); ?>
                  <?php echo form_input('badge_type_name_en', set_value('badge_type_name_en', $info->badge_type_name_en), 'id="badge_type_name_en" class="form-control input-sm"');?>
                </div>
              ...
              <div class="row form-row">
                ...
                <div class="col-md-6">
                  ...
                  <?php 
                    ...
                    if($info->badge_logo != NULL){
                        $src= $img_path.$info->badge_logo;
