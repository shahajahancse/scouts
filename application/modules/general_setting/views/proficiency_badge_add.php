       ...
       <div class="col-md-12">
          <div class="grid simple horizontal red">
             ...
             <div class="grid-body">
              ...
              echo form_open_multipart("general_setting/proficiency_badge_add");?>

              <div class="row form-row">
                <div class="col-md-6">
                  <label class="form-label">Select Section</label>
                  <?php echo form_error('section_id'); ?>
                  <?php echo form_dropdown('section_id',$section, set_value('section_id'), ' class="form-control input-sm" id="section_proficiency_badge"');?>
                </div>

                <div class="col-md-6">
                  <label class="form-label">Select Proficiency Badge Group</label>
                  <?php echo form_error('prof_badge_id'); ?>
                  <select name="prof_badge_id" class="proficiency_badge_group_val form-control input-sm">
                    <option value="">Select One</option>
                  </select>
                  <?php //echo form_dropdown('prof_badge_id',$section, set_value('prof_badge_id'), ' class="proficiency_badge_group_val form-control input-sm"');?>
                </div>
               
                <div class="col-md-6">
                  <label class="form-label">Proficiency Badge Name</label>
                  <?php echo form_error('prof_badge_name'); ?>
                  <input name="prof_badge_name" id="prof_badge_name" type="text" value="<?=set_value('prof_badge_name')?>" class="form-control input-sm" placeholder="">
                </div>
              </div>
