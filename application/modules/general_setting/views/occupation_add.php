       ...
       <div class="col-md-8">
          <div class="grid simple horizontal red">
             ...
             <div class="grid-body">
              ...
              echo form_open_multipart("general_setting/occupation_add", $attributes);?>

              <div class="row form-row">
                <div class="col-md-6">
                  <label class="form-label">Occupation Name (English)</label>
                  <?php echo form_error('occupation_name'); ?>
                  <input name="occupation_name" id="occupation_name" type="text" value="<?=set_value('occupation_name')?>" class="form-control input-sm" placeholder="e.g. Student">
                </div>
                <div class="col-md-6">
                  <label class="form-label">Occupation Name (Bangla)</label>
                  <?php echo form_error('occupation_name_bn'); ?>
                  <input name="occupation_name_bn" id="occupation_name_bn" type="text" value="<?=set_value('occupation_name_bn')?>" class="form-control input-sm" placeholder="উদাহরণ: ছাত্র">
                </div>
              </div>
