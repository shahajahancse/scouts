          ...
          <div class="grid-body">
            ...
            <div class="row form-row">
              <div class="col-md-6">
                ...
                <input name="designation_name" id="designation_name" type="text" value="<?=set_value('designation_name',$info->designation_name)?>" class="form-control input-sm" placeholder="">
