                ...
                ?>
                  <tr>
                    ...
                    <td class="btn-group-responsive">
                      <?php echo anchor(base_url()."general_setting/badge_type_edit/".$row->id, 'Edit', 'class="btn btn-mini btn-primary"') ;?>
                      <a class="btn btn-mini btn-primary" href="<?=base_url()?>general_setting/badge_type_delete/<?=$row->id?>" onclick="return confirm('Are you sure you want to delete this Badge Type?');">Delete</a>
                    </td>
                  </tr>
                  <?php endforeach;?>                      
                </tbody>
