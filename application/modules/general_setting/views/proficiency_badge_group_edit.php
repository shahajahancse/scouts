       ...
       <div class="col-md-8">
          <div class="grid simple horizontal red">
             ...
             <div class="grid-body">
              ...
              echo form_open_multipart("general_setting/proficiency_badge_group_edit/".$info->id);?>
              ...
              <div class="row form-row">
                ...
                <div class="col-md-6">
                  ...
                  <input name="prof_badge_group_name" id="prof_badge_group_name" type="text" value="<?=set_value('prof_badge_group_name', $info->prof_badge_group_name)?>" class="form-control input-sm" placeholder="">
                </div>
              </div>
