            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     ...
                     <a href="<?=base_url('offices/region_details/'.$info->id)?>" class="btn btn-success btn-xs btn-mini"> Region Details</a>  
                  </div>
               </div>
               <div class="grid-body">
                     ...
                     <div class="col-md-7">
                        ...
                        <div class="row form-row">
                           <div class="col-md-12">
                              ...
                              <input name="region_name" id="region_name" value="<?=set_value('region_name', $info->region_name)?>" type="text" class="form-control input-sm" placeholder="">
                           </div>
                        </div>
                        ...
                        <div class="row form-row">
                           <div class="col-md-12">
                              ...
                              <textarea name="region_description" class="form-control" rows="7"><?=set_value('region_description', $info->region_description)?></textarea>
                           </div>
                        </div>
                     </div>
