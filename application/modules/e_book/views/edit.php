   ...
   <div class="row">
     <div class="col-md-12">
      ...
      <div class="grid-body">
        ...
        echo form_open_multipart("e_book/edit/".$info->id, $attributes);
        ?>
          ...
          <div class="col-md-5">
            <div class="row form-row">
              <div class="col-md-12">
                ...
                <?php echo form_dropdown('category_id', $ebook_category, set_value('category_id', $info->category_id), 'class="form-control input-sm"'); ?>
              </div>
              <div class="col-md-12">
                <label class="form-label">Book Title <span class="required">*</span></label>
                <?php echo form_error('book_title'); ?>
                <input name="book_title" type="text" value="<?=set_value('book_title', $info->book_title)?>" class="form-control input-sm">
              </div>
              <div class="col-md-12">
                <label class="form-label">Description (Max. 200 character)</label>
                <?php echo form_error('description'); ?>
                <textarea name="description" class="form-control input-sm"><?=set_value('description', $info->description)?></textarea>
              </div>
              <div class="col-md-12">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-7">
                  <div class="col-md-12">
                    ...
                    <input name="total_page" type="number" value="<?=set_value('total_page', $info->total_page)?>" class="form-control input-sm">
                  </div>
                  ...
                  <div class="col-md-12" >
                    ...
                    <?php foreach ($ebook_index as $row) { ?>
                    <tr>
                     <td><input type="text" name="index_title[]" value="<?=$row->index_title?>" class="form-control input-sm"></td>
                     <td><input type="number" name="page_no[]" value="<?=$row->page_no?>" class="form-control input-sm"></td>
  ...
  // Ebook Indexs
   ...
   function removeRowEducationFunc(id){ 
      ...
      if (confirm("Are you sure you want to delete this information from database?") == true) {
         $.ajax({
          type: "POST",
          url: hostname+"e_book/ajax_ebook_index_del/"+dataId,
