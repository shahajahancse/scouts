                  ...
                  <table class="table table-hover table-condensed">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td> <?=$status?></td>
						   <td id="details"><a class="btn btn-mini btn-primary" href="<?=base_url('committee/upazila_details/'.$row->id)?>">Details</a></td>
                              <?php /*?><td class="v-align-middle">
                                 <div class="btn-group"> <a class="btn btn-mini btn-info dropdown-toggle btn-demo-space" data-toggle="dropdown" href="#"> Action <span class="caret"></span> </a>
                                    <ul class="dropdown-menu">
                                       <li><?php echo anchor("committee/upazila_update/".$row->id, 'Update') ;?></li>
                                       <li class="divider"></li>
                                       <li><a href="<?=base_url('committee/upazila_details/'.$row->id)?>">Details</a></li>
                                    </ul>
                                 </div>
                              </td><?php */?>
                           </tr>
