...
<script>
   function smr_region() {
      ...
      var startDate = document.getElementById("date_from").value;
      var endDate   = document.getElementById("date_to").value;
      var dateFrom = parseDDMMYYYY(startDate);
      var dateTo   = parseDDMMYYYY(endDate);
      ...
      // Compare
      if (dateTo > maxDate) {
         alert("Second Date must be less than 3 months");
         return false;
      }
