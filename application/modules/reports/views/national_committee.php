                  ...
                  <table class="table table-hover table-condensed">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td> <?=$status?></td>
						         <td id="details"> <?php ?>&nbsp;&nbsp;<a href="<?= base_url('committee/national_details/'.$row->id)?>" class="btn btn-mini btn-info">Details</a></td>
                       </tr>
                        <?php endforeach;?>                      
                     </tbody>
                  </table>
