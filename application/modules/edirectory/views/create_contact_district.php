...
<div class="page-content">     
   <div class="content">  
      <ul class="breadcrumb">
         ...
         <li> <a href="<?=base_url('edirectory/listing_district')?>" class="active"><?=$module_name?> </a> </li>
         <li><?=$meta_title; ?></li>
      </ul>
            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">     
                     <a href="<?=base_url('edirectory/listing_district')?>" class="btn btn-blueviolet btn-xs btn-mini"> E-Directory Contact</a>  &nbsp;
                  </div>
               </div>
               ...
               <div class="grid-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        echo form_open_multipart('edirectory/create_contact_district', $attributes);
                        ?>
                           ...
                           <div class="col-md-9">
                              ...
                              <div class="row form-row">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input name="profe_desig" id="" value="<?=set_value('profe_desig')?>" type="text" class="form-control input-sm" placeholder="Professional Designation">
                                 </div> 
                                 <div class="col-md-6">
