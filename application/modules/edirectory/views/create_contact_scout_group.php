...
<div class="page-content">     
   <div class="content">  
      <ul class="breadcrumb">
         ...
         <li> <a href="<?=base_url('edirectory/listing_scout_group')?>" class="active"><?=$module_name?> </a> </li>
         <li><?=$meta_title; ?></li>
      </ul>
            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">     
                     <a href="<?=base_url('edirectory/listing_scout_group')?>" class="btn btn-blueviolet btn-xs btn-mini"> E-Directory Contact</a>  &nbsp;
                  </div>
               </div>
               ...
               <div class="grid-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        echo form_open_multipart('edirectory/create_contact_scout_group', $attributes);
                        ?>
