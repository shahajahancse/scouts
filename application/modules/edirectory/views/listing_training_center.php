            ...
            <div class="grid simple ">
               <div class="grid-title">
                  ...
                  <div class="pull-right">
                     ...
                     <a href="<?=base_url('edirectory/create_tc')?>" class="btn btn-blueviolet btn-xs btn-mini"> Add Training Certer Contact</a>
                     <?php //} ?>
                  </div>            
               </div>
                  ...
                  <table class="table table-hover table-condensed" border="0">
                     <thead>
                        <tr>
                           ...
                           <th style="width:30%">Training Center Name</th>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td> <?=$row->tc_name?> </td>
                           <td> <strong><?=$row->tc_designation_name?></strong> </td>
                           <td> <?=$img_url?> </td>
                           <td> <?=$row->name?> </td>
                           <td> <?=$row->phone?> </td>
                           <td> <?=$row->email?> </td>
