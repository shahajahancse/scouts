      ...
      <div class="col-md-8">
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            echo form_open_multipart("edirectory/designation_edit/".$info->id, $attributes);?>

            <div class="row form-row">
              <div class="col-md-6">
                <label class="form-label"> Designation</label>
                <?php echo form_error('committee_designation_name'); ?>
                <input name="committee_designation_name" id="committee_designation_name" type="text" value="<?=set_value('committee_designation_name',$info->committee_designation_name_en)?>" class="form-control input-sm" placeholder="">
              </div>
