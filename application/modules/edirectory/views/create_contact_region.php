            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">     
                     <a href="<?=base_url('edirectory/listing_region')?>" class="btn btn-blueviolet btn-xs btn-mini"> E-Directory Contact</a>  &nbsp;
                  </div>
               </div>
               ...
               <div class="grid-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        echo form_open_multipart('edirectory/create_contact_region', $attributes);
                        ?>
