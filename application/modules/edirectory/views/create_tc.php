...
<div class="page-content">     
   <div class="content">  
      <ul class="breadcrumb">
         ...
         <li> <a href="<?=base_url('edirectory/listing_training_center')?>" class="active"><?=$module_name?> </a> </li>
         <li><?=$meta_title; ?></li>
      </ul>
            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">     
                     <a href="<?=base_url('edirectory/listing_training_center')?>" class="btn btn-blueviolet btn-xs btn-mini"> E-Directory Contact</a>  &nbsp;
                  </div>
               </div>
               ...
               <div class="grid-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        echo form_open_multipart('edirectory/create_tc', $attributes);
                        ?>

                        <div class="row form-row">
                           <div class="col-md-3">
                              <label class="form-label">Select Training Center</label>
                              <?php echo form_error('tc_id');
                              $more_attr = 'class="form-control input-sm"';
                              echo form_dropdown('tc_id', $training_centers, set_value('tc_id'), $more_attr);
                              ?>
                           </div>
                           <div class="col-md-3">
                              <label class="form-label">Designation Name</label>
                              <?php echo form_error('tc_designation_name'); ?>
                              <input name="tc_designation_name" value="<?=set_value('tc_designation_name')?>" type="text" class="form-control input-sm" placeholder="">
                           </div>
                           <div class="col-md-3">
...
<script type="text/javascript">  
   $(document).ready(function() {
      ...
      $('#validate').validate({
         ...
         rules: {
            tc_id: { required: true },            
            tc_designation_name: { required: true },            
